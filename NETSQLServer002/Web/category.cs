   ...
   public class category : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV7CategoryId = (short)(Math.Round(NumberUtil.Val( GetPar( "CategoryId"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void DrawControls( )
      {
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_select_Internalname, "", "Seleccionar", bttBtn_select_Jsonclick, 5, "Seleccionar", "", StyleString, ClassString, bttBtn_select_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CategoryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCategoryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A4CategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(A4CategoryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, A5CategoryName, StringUtil.RTrim( context.localUtil.Format( A5CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z5CategoryName = cgiGet( "Z5CategoryName");
               IsConfirmed = (short)(Math.Round(context.localUtil.CToN( cgiGet( "IsConfirmed"), ",", "."), 18, MidpointRounding.ToEven));
               IsModified = (short)(Math.Round(context.localUtil.CToN( cgiGet( "IsModified"), ",", "."), 18, MidpointRounding.ToEven));
               Gx_mode = cgiGet( "Mode");
               AV7CategoryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCATEGORYID"), ",", "."), 18, MidpointRounding.ToEven));
               ...
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A4CategoryId != Z4CategoryId ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
               {
      ...
      protected void ZM022( short GX_JID )
      {
         if ( ( GX_JID == 4 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z5CategoryName = T00023_A5CategoryName[0];
            }
            else
            {
      ...
      protected void Load022( )
      {
         ...
         {
            RcdFound2 = 1;
            A5CategoryName = T00024_A5CategoryName[0];
            AssignAttri("", false, "A5CategoryName", A5CategoryName);
            ZM022( -4) ;
         }
         pr_default.close(2);
      ...
      protected void CheckExtendedTable022( )
      {
         ...
         {
            GX_msglist.addItem("El nombre no puede estar vacio", 1, "CATEGORYNAME");
            AnyError = 1;
            GX_FocusControl = edtCategoryName_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM022( 4) ;
            RcdFound2 = 1;
            A4CategoryId = T00023_A4CategoryId[0];
            AssignAttri("", false, "A4CategoryId", StringUtil.LTrimStr( (decimal)(A4CategoryId), 4, 0));
            A5CategoryName = T00023_A5CategoryName[0];
            AssignAttri("", false, "A5CategoryName", A5CategoryName);
            Z4CategoryId = A4CategoryId;
            sMode2 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound2 = 0;
         /* Using cursor T00027 */
         pr_default.execute(5, new Object[] {A4CategoryId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00027_A4CategoryId[0] < A4CategoryId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00027_A4CategoryId[0] > A4CategoryId ) ) )
            {
               A4CategoryId = T00027_A4CategoryId[0];
               AssignAttri("", false, "A4CategoryId", StringUtil.LTrimStr( (decimal)(A4CategoryId), 4, 0));
               RcdFound2 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound2 = 0;
         /* Using cursor T00028 */
         pr_default.execute(6, new Object[] {A4CategoryId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T00028_A4CategoryId[0] > A4CategoryId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T00028_A4CategoryId[0] < A4CategoryId ) ) )
            {
               A4CategoryId = T00028_A4CategoryId[0];
               AssignAttri("", false, "A4CategoryId", StringUtil.LTrimStr( (decimal)(A4CategoryId), 4, 0));
               RcdFound2 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency022( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z5CategoryName, T00022_A5CategoryName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z5CategoryName, T00022_A5CategoryName[0]) != 0 )
               {
                  GXUtil.WriteLog("category:[seudo value changed for attri]"+"CategoryName");
                  GXUtil.WriteLogRaw("Old: ",Z5CategoryName);
                  GXUtil.WriteLogRaw("Current: ",T00022_A5CategoryName[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00029 */
                     pr_default.execute(7, new Object[] {A5CategoryName});
                     A4CategoryId = T00029_A4CategoryId[0];
                     AssignAttri("", false, "A4CategoryId", StringUtil.LTrimStr( (decimal)(A4CategoryId), 4, 0));
                     pr_default.close(7);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A5CategoryName, A4CategoryId});
                     pr_default.close(8);
                     pr_default.SmartCacheProvider.SetUpdated("Category");
      ...
      protected void OnDeleteControls022( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(10, new Object[] {A4CategoryId});
      ...
      public void ScanStart022( )
      {
         ...
         {
            RcdFound2 = 1;
            A4CategoryId = T000213_A4CategoryId[0];
            AssignAttri("", false, "A4CategoryId", StringUtil.LTrimStr( (decimal)(A4CategoryId), 4, 0));
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z5CategoryName", Z5CategoryName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411717481691", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("category.js", "?202411717481691", false, true);
      ...
      public void Valid_Categoryname( )
      {
         ...
         pr_default.execute(12, new Object[] {A5CategoryName, A4CategoryId});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV9TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV7CategoryId","fld":"vCATEGORYID","pic":"ZZZ9","hsh":true},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]}""");
         ...
         setEventMetadata("VALID_CATEGORYNAME","""{"handler":"Valid_Categoryname","iparms":[{"av":"A5CategoryName","fld":"CATEGORYNAME"},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00024_A4CategoryId = new short[1] ;
         T00024_A5CategoryName = new string[] {""} ;
         T00025_A5CategoryName = new string[] {""} ;
         T00026_A4CategoryId = new short[1] ;
         T00023_A4CategoryId = new short[1] ;
         T00023_A5CategoryName = new string[] {""} ;
         T00027_A4CategoryId = new short[1] ;
         T00028_A4CategoryId = new short[1] ;
         T00022_A4CategoryId = new short[1] ;
         T00022_A5CategoryName = new string[] {""} ;
         T00029_A4CategoryId = new short[1] ;
         T000212_A10ProductId = new short[1] ;
         T000213_A4CategoryId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         T000214_A5CategoryName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.category__default(),
            new Object[][] {
                new Object[] {
               T00022_A4CategoryId, T00022_A5CategoryName
               }
               , new Object[] {
               T00023_A4CategoryId, T00023_A5CategoryName
               }
               , new Object[] {
               T00024_A4CategoryId, T00024_A5CategoryName
               }
               , new Object[] {
               T00025_A5CategoryName
               }
               , new Object[] {
               T00026_A4CategoryId
               }
               ...
               , new Object[] {
               T000212_A10ProductId
               }
               , new Object[] {
               T000213_A4CategoryId
               }
               , new Object[] {
               T000214_A5CategoryName
               }
            }
         );
         AV11Pgmname = "Category";
      ...
      private short[] T00024_A4CategoryId ;
      private string[] T00024_A5CategoryName ;
      private string[] T00025_A5CategoryName ;
      private short[] T00026_A4CategoryId ;
      private short[] T00023_A4CategoryId ;
      private string[] T00023_A5CategoryName ;
      private short[] T00027_A4CategoryId ;
      private short[] T00028_A4CategoryId ;
      private short[] T00022_A4CategoryId ;
      private string[] T00022_A5CategoryName ;
      private short[] T00029_A4CategoryId ;
      private short[] T000212_A10ProductId ;
      private short[] T000213_A4CategoryId ;
      private string[] T000214_A5CategoryName ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T00029", "INSERT INTO [Category]([CategoryName]) VALUES(@CategoryName); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT00029,1, GxCacheFrequency.OFF ,true,true )
