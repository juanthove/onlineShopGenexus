   ...
   public class countrycustomerwc : GXWebComponent
   {
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CountryCustomerWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtCountryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CountryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCountryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9") : context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,33);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", edtCountryId_Visible, edtCountryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CountryCustomerWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CUSTOMERID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CUSTOMERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CustomerId), 4, 0, ".", "")));
      }
      ...
      protected void RF0T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1CountryId = H000T2_A1CountryId[0];
               AssignAttri(sPrefix, false, "A1CountryId", StringUtil.LTrimStr( (decimal)(A1CountryId), 4, 0));
               A19CustomerPhone = H000T2_A19CustomerPhone[0];
               A18CustomerEmail = H000T2_A18CustomerEmail[0];
               A17CustomerDirectionDestination = H000T2_A17CustomerDirectionDestination[0];
               A16CustomerName = H000T2_A16CustomerName[0];
               A15CustomerId = H000T2_A15CustomerId[0];
               /* Execute user event: Grid.Load */
               E130T2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CUSTOMERID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9"), context));
      }
      ...
      private void E130T2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("customer.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A15CustomerId,4,0))}, new string[] {"Mode","CustomerId"}) ;
         edtavDelete_Link = formatLink("customer.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A15CustomerId,4,0))}, new string[] {"Mode","CustomerId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410192326364", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("countrycustomerwc.js", "?202410192326364", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtCustomerEmail_Internalname = sPrefix+"CUSTOMEREMAIL_"+sGXsfl_22_idx;
         edtCustomerPhone_Internalname = sPrefix+"CUSTOMERPHONE_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtCustomerEmail_Internalname = sPrefix+"CUSTOMEREMAIL_"+sGXsfl_22_fel_idx;
         edtCustomerPhone_Internalname = sPrefix+"CUSTOMERPHONE_"+sGXsfl_22_fel_idx;
      ...
      protected void StartGridControl22( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A18CustomerEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A19CustomerPhone)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CountryId","fld":"vCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130T2","iparms":[{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110T2","iparms":[{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CountryId","fld":"vCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CountryId","fld":"vCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CountryId","fld":"vCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CountryId","fld":"vCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A18CustomerEmail = "";
         A19CustomerPhone = "";
         H000T2_A1CountryId = new short[1] ;
         H000T2_A19CustomerPhone = new string[] {""} ;
         H000T2_A18CustomerEmail = new string[] {""} ;
         H000T2_A17CustomerDirectionDestination = new string[] {""} ;
         H000T2_A16CustomerName = new string[] {""} ;
         H000T2_A15CustomerId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.countrycustomerwc__default(),
            new Object[][] {
                new Object[] {
               H000T2_A1CountryId, H000T2_A19CustomerPhone, H000T2_A18CustomerEmail, H000T2_A17CustomerDirectionDestination, H000T2_A16CustomerName, H000T2_A15CustomerId
               }
               , new Object[] {
      ...
      private short[] H000T2_A1CountryId ;
      private string[] H000T2_A19CustomerPhone ;
      private string[] H000T2_A18CustomerEmail ;
      private string[] H000T2_A17CustomerDirectionDestination ;
      private string[] H000T2_A16CustomerName ;
      private short[] H000T2_A15CustomerId ;
   ...
   public class countrycustomerwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT [CountryId], [CustomerPhone], [CustomerEmail], [CustomerDirectionDestination], [CustomerName], [CustomerId] FROM [Customer] WHERE [CountryId] = @AV6CountryId ORDER BY [CountryId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000T3", "SELECT COUNT(*) FROM [Customer] WHERE [CountryId] = @AV6CountryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
