...
namespace GeneXus.Programs {
   public class countryproductwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ProductCountryId = (short)(Math.Round(NumberUtil.Val( GetPar( "ProductCountryId"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6ProductCountryId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CountryProductWC.htm");
      ...
      protected void RF1C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A41ProductCountryId = H001C2_A41ProductCountryId[0];
               AssignAttri(sPrefix, false, "A41ProductCountryId", StringUtil.LTrimStr( (decimal)(A41ProductCountryId), 4, 0));
               A5CategoryName = H001C2_A5CategoryName[0];
               A4CategoryId = H001C2_A4CategoryId[0];
               A25SupplierName = H001C2_A25SupplierName[0];
               A24SupplierId = H001C2_A24SupplierId[0];
               A7SellerName = H001C2_A7SellerName[0];
               A6SellerId = H001C2_A6SellerId[0];
               A40000ProductImage_GXI = H001C2_A40000ProductImage_GXI[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A13ProductPrice = H001C2_A13ProductPrice[0];
               A12ProductDescription = H001C2_A12ProductDescription[0];
               A11ProductName = H001C2_A11ProductName[0];
               A10ProductId = H001C2_A10ProductId[0];
               A14ProductImage = H001C2_A14ProductImage[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A5CategoryName = H001C2_A5CategoryName[0];
               A25SupplierName = H001C2_A25SupplierName[0];
      ...
      protected void STRUP1C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ProductCountryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ProductCountryId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ProductCountryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6ProductCountryId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6ProductCountryId", StringUtil.LTrimStr( (decimal)(AV6ProductCountryId), 4, 0));
         }
         else
         {
            AV6ProductCountryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6ProductCountryId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411250211958", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("countryproductwc.js", "?202411250211958", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductCountryId","fld":"vPRODUCTCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E131C2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true},{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9"},{"av":"A24SupplierId","fld":"SUPPLIERID","pic":"ZZZ9"},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E111C2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductCountryId","fld":"vPRODUCTCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductCountryId","fld":"vPRODUCTCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductCountryId","fld":"vPRODUCTCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductCountryId","fld":"vPRODUCTCOUNTRYID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A25SupplierName = "";
         A5CategoryName = "";
         H001C2_A41ProductCountryId = new short[1] ;
         H001C2_A5CategoryName = new string[] {""} ;
         H001C2_A4CategoryId = new short[1] ;
         H001C2_A25SupplierName = new string[] {""} ;
         H001C2_A24SupplierId = new short[1] ;
         H001C2_A7SellerName = new string[] {""} ;
         H001C2_A6SellerId = new short[1] ;
         H001C2_A40000ProductImage_GXI = new string[] {""} ;
         H001C2_A13ProductPrice = new decimal[1] ;
         H001C2_A12ProductDescription = new string[] {""} ;
         H001C2_A11ProductName = new string[] {""} ;
         H001C2_A10ProductId = new short[1] ;
         H001C2_A14ProductImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.countryproductwc__default(),
            new Object[][] {
                new Object[] {
               H001C2_A41ProductCountryId, H001C2_A5CategoryName, H001C2_A4CategoryId, H001C2_A25SupplierName, H001C2_A24SupplierId, H001C2_A7SellerName, H001C2_A6SellerId, H001C2_A40000ProductImage_GXI, H001C2_A13ProductPrice, H001C2_A12ProductDescription,
               H001C2_A11ProductName, H001C2_A10ProductId, H001C2_A14ProductImage
               }
               , new Object[] {
      ...
      private short[] H001C2_A41ProductCountryId ;
      private string[] H001C2_A5CategoryName ;
      private short[] H001C2_A4CategoryId ;
      private string[] H001C2_A25SupplierName ;
      private short[] H001C2_A24SupplierId ;
      private string[] H001C2_A7SellerName ;
      private short[] H001C2_A6SellerId ;
      private string[] H001C2_A40000ProductImage_GXI ;
      private decimal[] H001C2_A13ProductPrice ;
      private string[] H001C2_A12ProductDescription ;
      private string[] H001C2_A11ProductName ;
      private short[] H001C2_A10ProductId ;
      private string[] H001C2_A14ProductImage ;
   ...
   public class countryproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001C2", "SELECT T1.[ProductCountryId], T2.[CategoryName], T1.[CategoryId], T3.[SupplierName], T1.[SupplierId], T4.[SellerName], T1.[SellerId], T1.[ProductImage_GXI], T1.[ProductPrice], T1.[ProductDescription], T1.[ProductName], T1.[ProductId], T1.[ProductImage] FROM ((([Product] T1 INNER JOIN [Category] T2 ON T2.[CategoryId] = T1.[CategoryId]) INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T1.[SupplierId]) INNER JOIN [Seller] T4 ON T4.[SellerId] = T1.[SellerId]) WHERE T1.[ProductCountryId] = @AV6ProductCountryId ORDER BY T1.[ProductCountryId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001C3", "SELECT COUNT(*) FROM ((([Product] T1 INNER JOIN [Category] T4 ON T4.[CategoryId] = T1.[CategoryId]) INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T1.[SupplierId]) INNER JOIN [Seller] T2 ON T2.[SellerId] = T1.[SellerId]) WHERE T1.[ProductCountryId] = @AV6ProductCountryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
