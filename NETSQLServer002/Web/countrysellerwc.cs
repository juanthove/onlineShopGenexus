   ...
   public class countrysellerwc : GXWebComponent
   {
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CountrySellerWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtCountryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CountryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCountryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9") : context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,31);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", edtCountryId_Visible, edtCountryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CountrySellerWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SELLERID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A6SellerId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"SELLERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A6SellerId), 4, 0, ".", "")));
      }
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1CountryId = H000S2_A1CountryId[0];
               AssignAttri(sPrefix, false, "A1CountryId", StringUtil.LTrimStr( (decimal)(A1CountryId), 4, 0));
               A40000SellerPhoto_GXI = H000S2_A40000SellerPhoto_GXI[0];
               AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               A7SellerName = H000S2_A7SellerName[0];
               A6SellerId = H000S2_A6SellerId[0];
               A8SellerPhoto = H000S2_A8SellerPhoto[0];
               AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               /* Execute user event: Grid.Load */
               E130S2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SELLERID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A6SellerId), "ZZZ9"), context));
      }
      ...
      private void E130S2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("seller.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A6SellerId,4,0))}, new string[] {"Mode","SellerId"}) ;
         edtavDelete_Link = formatLink("seller.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A6SellerId,4,0))}, new string[] {"Mode","SellerId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101923454087", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("countrysellerwc.js", "?2024101923454088", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtSellerPhoto_Internalname = sPrefix+"SELLERPHOTO_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtSellerPhoto_Internalname = sPrefix+"SELLERPHOTO_"+sGXsfl_22_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130S2","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110S2","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000S2_A1CountryId = new short[1] ;
         H000S2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000S2_A7SellerName = new string[] {""} ;
         H000S2_A6SellerId = new short[1] ;
         H000S2_A8SellerPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.countrysellerwc__default(),
            new Object[][] {
                new Object[] {
               H000S2_A1CountryId, H000S2_A40000SellerPhoto_GXI, H000S2_A7SellerName, H000S2_A6SellerId, H000S2_A8SellerPhoto
               }
               , new Object[] {
      ...
      private short[] H000S2_A1CountryId ;
      private string[] H000S2_A40000SellerPhoto_GXI ;
      private string[] H000S2_A7SellerName ;
      private short[] H000S2_A6SellerId ;
      private string[] H000S2_A8SellerPhoto ;
   ...
   public class countrysellerwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [CountryId], [SellerPhoto_GXI], [SellerName], [SellerId], [SellerPhoto] FROM [Seller] WHERE [CountryId] = @AV6CountryId ORDER BY [CountryId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000S3", "SELECT COUNT(*) FROM [Seller] WHERE [CountryId] = @AV6CountryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
