...
namespace GeneXus.Programs {
   public class customerpointcardwc : GXWebComponent
   {
      public customerpointcardwc( )
      {
      ...
      public customerpointcardwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6CustomerId = (short)(Math.Round(NumberUtil.Val( GetPar( "CustomerId"), "."), 18, MidpointRounding.ToEven));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "CustomerPointCardWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Customer Point Card WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customerpointcardwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6CustomerId,4,0))}, new string[] {"CustomerId"}) +"\">") ;
      ...
      {
         return "CustomerPointCardWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Customer Point Card WC" ;
      }
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "customerpointcardwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CustomerPointCardWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CustomerId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCustomerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,31);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerId_Jsonclick, 0, "Attribute", "", "", "", "", edtCustomerId_Visible, edtCustomerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CustomerPointCardWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Customer Point Card WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_POINTCARDID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A20PointCardId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"POINTCARDID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A20PointCardId), 4, 0, ".", "")));
      }
      ...
      protected void RF0W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15CustomerId = H000W2_A15CustomerId[0];
               AssignAttri(sPrefix, false, "A15CustomerId", StringUtil.LTrimStr( (decimal)(A15CustomerId), 4, 0));
               A23PointCardVIP = H000W2_A23PointCardVIP[0];
               A22PointCardPoints = H000W2_A22PointCardPoints[0];
               A20PointCardId = H000W2_A20PointCardId[0];
               /* Execute user event: Grid.Load */
               E130W2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_POINTCARDID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A20PointCardId), "ZZZ9"), context));
      }
      ...
      protected void STRUP0W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6CustomerId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E110W2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("pointcard.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","PointCardId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "PointCard";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "customerpointcardwc", GetJustCreated( ));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6CustomerId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6CustomerId", StringUtil.LTrimStr( (decimal)(AV6CustomerId), 4, 0));
         }
         else
         {
            AV6CustomerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6CustomerId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241092001569", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("customerpointcardwc.js", "?20241092001569", false, true);
         }
      ...
      {
         edtPointCardId_Internalname = sPrefix+"POINTCARDID_"+sGXsfl_22_idx;
         edtPointCardPoints_Internalname = sPrefix+"POINTCARDPOINTS_"+sGXsfl_22_idx;
         chkPointCardVIP_Internalname = sPrefix+"POINTCARDVIP_"+sGXsfl_22_idx;
      ...
      {
         edtPointCardId_Internalname = sPrefix+"POINTCARDID_"+sGXsfl_22_fel_idx;
         edtPointCardPoints_Internalname = sPrefix+"POINTCARDPOINTS_"+sGXsfl_22_fel_idx;
         chkPointCardVIP_Internalname = sPrefix+"POINTCARDVIP_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPointCardId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A20PointCardId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A20PointCardId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtPointCardId_Link,(string)"",(string)"",(string)"",(string)edtPointCardId_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPointCardPoints_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A22PointCardPoints), 8, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A22PointCardPoints), "ZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPointCardPoints_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "POINTCARDVIP_" + sGXsfl_22_idx;
            chkPointCardVIP.Name = GXCCtl;
            chkPointCardVIP.WebTags = "";
            chkPointCardVIP.Caption = "";
            AssignProp(sPrefix, false, chkPointCardVIP_Internalname, "TitleCaption", chkPointCardVIP.Caption, !bGXsfl_22_Refreshing);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CustomerId","fld":"vCUSTOMERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130W2","iparms":[{"av":"A20PointCardId","fld":"POINTCARDID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtPointCardId_Link","ctrl":"POINTCARDID","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110W2","iparms":[{"av":"A20PointCardId","fld":"POINTCARDID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CustomerId","fld":"vCUSTOMERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CustomerId","fld":"vCUSTOMERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CustomerId","fld":"vCUSTOMERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6CustomerId","fld":"vCUSTOMERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H000W2_A15CustomerId = new short[1] ;
         H000W2_A23PointCardVIP = new bool[] {false} ;
         H000W2_A22PointCardPoints = new int[1] ;
         H000W2_A20PointCardId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customerpointcardwc__default(),
            new Object[][] {
                new Object[] {
               H000W2_A15CustomerId, H000W2_A23PointCardVIP, H000W2_A22PointCardPoints, H000W2_A20PointCardId
               }
               , new Object[] {
      ...
      private short[] H000W2_A15CustomerId ;
      private bool[] H000W2_A23PointCardVIP ;
      private int[] H000W2_A22PointCardPoints ;
      private short[] H000W2_A20PointCardId ;
   ...
   public class customerpointcardwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000W2", "SELECT [CustomerId], [PointCardVIP], [PointCardPoints], [PointCardId] FROM [PointCard] WHERE [CustomerId] = @AV6CustomerId ORDER BY [CustomerId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000W2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000W3", "SELECT COUNT(*) FROM [PointCard] WHERE [CustomerId] = @AV6CustomerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000W3,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
