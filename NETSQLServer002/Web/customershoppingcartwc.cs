...
namespace GeneXus.Programs {
   public class customershoppingcartwc : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "CustomerShoppingCartWC";
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CustomerShoppingCartWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CustomerId), 4, 0, ",", "")), StringUtil.LTrim( ((edtCustomerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerId_Jsonclick, 0, "Attribute", "", "", "", "", edtCustomerId_Visible, edtCustomerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CustomerShoppingCartWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF162( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15CustomerId = H00169_A15CustomerId[0];
               AssignAttri(sPrefix, false, "A15CustomerId", StringUtil.LTrimStr( (decimal)(A15CustomerId), 4, 0));
               A31ShoppingCartId = H00169_A31ShoppingCartId[0];
               A33ShoppingCartTotalCost = H00169_A33ShoppingCartTotalCost[0];
               n33ShoppingCartTotalCost = H00169_n33ShoppingCartTotalCost[0];
               A34ShoppingCartDate = H00169_A34ShoppingCartDate[0];
               A33ShoppingCartTotalCost = H00169_A33ShoppingCartTotalCost[0];
               n33ShoppingCartTotalCost = H00169_n33ShoppingCartTotalCost[0];
      ...
      {
         /* Using cursor H001617 */
         pr_default.execute(1, new Object[] {AV6CustomerId});
         GRID_nRecordCount = H001617_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411817223587", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("customershoppingcartwc.js", "?202411817223587", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E13162","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E11162","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         H00169_A15CustomerId = new short[1] ;
         H00169_A31ShoppingCartId = new short[1] ;
         H00169_A33ShoppingCartTotalCost = new decimal[1] ;
         H00169_n33ShoppingCartTotalCost = new bool[] {false} ;
         H00169_A34ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         H001617_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customershoppingcartwc__default(),
            new Object[][] {
                new Object[] {
               H00169_A15CustomerId, H00169_A31ShoppingCartId, H00169_A33ShoppingCartTotalCost, H00169_n33ShoppingCartTotalCost, H00169_A34ShoppingCartDate
               }
               , new Object[] {
               H001617_AGRID_nRecordCount
               }
            }
         );
         AV15Pgmname = "CustomerShoppingCartWC";
      ...
      private short[] H00169_A15CustomerId ;
      private short[] H00169_A31ShoppingCartId ;
      private decimal[] H00169_A33ShoppingCartTotalCost ;
      private bool[] H00169_n33ShoppingCartTotalCost ;
      private DateTime[] H00169_A34ShoppingCartDate ;
      private long[] H001617_AGRID_nRecordCount ;
   ...
   public class customershoppingcartwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00169;
          prmH00169 = new Object[] {
          new ParDef("@AV6CustomerId",GXType.Int16,4,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH001617;
          prmH001617 = new Object[] {
          new ParDef("@AV6CustomerId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00169", "SELECT T1.[CustomerId], T1.[ShoppingCartId], COALESCE( T2.[ShoppingCartTotalCost], 0) AS ShoppingCartTotalCost, T1.[ShoppingCartDate] FROM ([ShoppingCart] T1 LEFT JOIN (SELECT SUM(COALESCE( T4.[ProductTotalCost], 0)) AS ShoppingCartTotalCost, T3.[ShoppingCartId] FROM ([ShoppingCartProducts] T3 INNER JOIN (SELECT ( COALESCE( T6.[ProductFinalPrice], 0)) * CAST(T5.[ProductQuantity] AS decimal( 28, 10)) AS ProductTotalCost, T5.[ShoppingCartId], T5.[ProductId] FROM ([ShoppingCartProducts] T5 INNER JOIN (SELECT CASE  WHEN T10.[CategoryId] = COALESCE( T9.[CategoryId], 0) THEN T10.[ProductPrice] + ( T10.[ProductPrice] * CAST(0.05 AS decimal( 28, 10))) WHEN T10.[CategoryId] = COALESCE( T8.[CategoryId], 0) THEN T10.[ProductPrice] - ( T10.[ProductPrice] * CAST(0.1 AS decimal( 28, 10))) ELSE T10.[ProductPrice] END AS ProductFinalPrice, T7.[ShoppingCartId], T7.[ProductId] FROM ((([ShoppingCartProducts] T7 INNER JOIN [Product] T10 ON T10.[ProductId] = T7.[ProductId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Entretenimiento' ) T8 ON T8.[CategoryId] = T10.[CategoryId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Joyeria' ) T9 ON T9.[CategoryId] = T10.[CategoryId]) ) T6 ON T6.[ShoppingCartId] = T5.[ShoppingCartId] AND T6.[ProductId] = T5.[ProductId]) ) T4 ON T4.[ShoppingCartId] = T3.[ShoppingCartId] AND T4.[ProductId] = T3.[ProductId]) GROUP BY T3.[ShoppingCartId] ) T2 ON T2.[ShoppingCartId] = T1.[ShoppingCartId]) WHERE T1.[CustomerId] = @AV6CustomerId ORDER BY T1.[CustomerId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00169,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001617", "SELECT COUNT(*) FROM ([ShoppingCart] T1 LEFT JOIN (SELECT SUM(COALESCE( T4.[ProductTotalCost], 0)) AS ShoppingCartTotalCost, T3.[ShoppingCartId] FROM ([ShoppingCartProducts] T3 INNER JOIN (SELECT ( COALESCE( T6.[ProductFinalPrice], 0)) * CAST(T5.[ProductQuantity] AS decimal( 28, 10)) AS ProductTotalCost, T5.[ShoppingCartId], T5.[ProductId] FROM ([ShoppingCartProducts] T5 INNER JOIN (SELECT CASE  WHEN T10.[CategoryId] = COALESCE( T9.[CategoryId], 0) THEN T10.[ProductPrice] + ( T10.[ProductPrice] * CAST(0.05 AS decimal( 28, 10))) WHEN T10.[CategoryId] = COALESCE( T8.[CategoryId], 0) THEN T10.[ProductPrice] - ( T10.[ProductPrice] * CAST(0.1 AS decimal( 28, 10))) ELSE T10.[ProductPrice] END AS ProductFinalPrice, T7.[ShoppingCartId], T7.[ProductId] FROM ((([ShoppingCartProducts] T7 INNER JOIN [Product] T10 ON T10.[ProductId] = T7.[ProductId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Entretenimiento' ) T8 ON T8.[CategoryId] = T10.[CategoryId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Joyeria' ) T9 ON T9.[CategoryId] = T10.[CategoryId]) ) T6 ON T6.[ShoppingCartId] = T5.[ShoppingCartId] AND T6.[ProductId] = T5.[ProductId]) ) T4 ON T4.[ShoppingCartId] = T3.[ShoppingCartId] AND T4.[ProductId] = T3.[ProductId]) GROUP BY T3.[ShoppingCartId] ) T2 ON T2.[ShoppingCartId] = T1.[ShoppingCartId]) WHERE T1.[CustomerId] = @AV6CustomerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001617,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
