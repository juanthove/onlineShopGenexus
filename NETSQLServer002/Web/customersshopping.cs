...
namespace GeneXus.Programs {
   public class customersshopping : GXProcedure
   {
      ...
      public customersshopping( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         ClassLoader.Execute("acustomersshopping","GeneXus.Programs","acustomersshopping", new Object[] {context }, "execute", args);
