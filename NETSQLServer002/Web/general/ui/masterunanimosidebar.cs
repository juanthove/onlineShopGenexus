...
namespace GeneXus.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?202411418525199", false, true);
      ...
      protected void WB010( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "c21a410f-c95b-46ef-b9c5-08432e185cb4", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 50, "px", 50, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_General/UI/MasterUnanimoSidebar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "Center", "top", "", "flex-grow:1;min-height:20px;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "ONLINE SHOP - www.onlineshop.com", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, 0, "HLP_General/UI/MasterUnanimoSidebar.htm");
      ...
      protected void E11012( )
      {
         /* Load Routine */
         returnInSub = false;
         Sidebarmenu_Title = "Menu Options";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20241141852526", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20241141852526", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon-loader.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
