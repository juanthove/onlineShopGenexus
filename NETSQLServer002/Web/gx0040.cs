...
namespace GeneXus.Programs {
   public class gx0040 : GXDataArea
   {
      ...
      {
         this.AV12pProductId = 0 ;
         ExecuteImpl();
         aP0_pProductId=this.AV12pProductId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12pProductId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12pProductId", StringUtil.LTrimStr( (decimal)(AV12pProductId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV9cSellerId = (short)(Math.Round(NumberUtil.Val( GetPar( "cSellerId"), "."), 18, MidpointRounding.ToEven));
         AV10cSupplierId = (short)(Math.Round(NumberUtil.Val( GetPar( "cSupplierId"), "."), 18, MidpointRounding.ToEven));
         AV11cCategoryId = (short)(Math.Round(NumberUtil.Val( GetPar( "cCategoryId"), "."), 18, MidpointRounding.ToEven));
         AV14cProductCountryId = (short)(Math.Round(NumberUtil.Val( GetPar( "cProductCountryId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProductId, AV7cProductName, AV8cProductPrice, AV9cSellerId, AV10cSupplierId, AV11cCategoryId, AV14cProductCountryId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0040.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12pProductId,4,0))}, new string[] {"pProductId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRODUCTPRICE", StringUtil.LTrim( StringUtil.NToC( AV8cProductPrice, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCSELLERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cSellerId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCSUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cSupplierId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGORYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cCategoryId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRODUCTCOUNTRYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14cProductCountryId), 4, 0, ",", "")));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_84", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_84), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPPRODUCTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12pProductId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx0040.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12pProductId,4,0))}, new string[] {"pProductId"})  ;
      }
      ...
      protected void WB1A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductidfilter_Internalname, "Product Id", "", "", lblLblproductidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductnamefilter_Internalname, "Product Name", "", "", lblLblproductnamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e121a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCproductname_Internalname, AV7cProductName, StringUtil.RTrim( context.localUtil.Format( AV7cProductName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCproductname_Visible, edtavCproductname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductpricefilter_Internalname, "Product Price", "", "", lblLblproductpricefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e131a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCproductprice_Internalname, StringUtil.LTrim( StringUtil.NToC( AV8cProductPrice, 18, 2, ",", "")), StringUtil.LTrim( ((edtavCproductprice_Enabled!=0) ? context.localUtil.Format( AV8cProductPrice, "ZZZZZZZZZZZZZZ9.99") : context.localUtil.Format( AV8cProductPrice, "ZZZZZZZZZZZZZZ9.99"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductprice_Jsonclick, 0, "Attribute", "", "", "", "", edtavCproductprice_Visible, edtavCproductprice_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSelleridfiltercontainer_Internalname, 1, 0, "px", 0, "px", divSelleridfiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblselleridfilter_Internalname, "Seller Id", "", "", lblLblselleridfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e141a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsellerid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cSellerId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCsellerid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9cSellerId), "ZZZ9") : context.localUtil.Format( (decimal)(AV9cSellerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsellerid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsellerid_Visible, edtavCsellerid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsupplieridfilter_Internalname, "Supplier Id", "", "", lblLblsupplieridfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e151a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsupplierid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cSupplierId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCsupplierid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV10cSupplierId), "ZZZ9") : context.localUtil.Format( (decimal)(AV10cSupplierId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsupplierid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsupplierid_Visible, edtavCsupplierid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategoryidfilter_Internalname, "Category Id", "", "", lblLblcategoryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e161a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cCategoryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCcategoryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV11cCategoryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV11cCategoryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoryid_Visible, edtavCcategoryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divProductcountryidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divProductcountryidfiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductcountryidfilter_Internalname, "Product Country Id", "", "", lblLblproductcountryidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e171a1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCproductcountryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14cProductCountryId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCproductcountryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV14cProductCountryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV14cProductCountryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductcountryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCproductcountryid_Visible, edtavCproductcountryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e181a1_client"+"'", TempTags, "", 2, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_84_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCSELLERID"), ",", ".") != Convert.ToDecimal( AV9cSellerId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Csupplierid Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCSUPPLIERID"), ",", ".") != Convert.ToDecimal( AV10cSupplierId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRODUCTCOUNTRYID"), ",", ".") != Convert.ToDecimal( AV14cProductCountryId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        short AV9cSellerId ,
                                        short AV10cSupplierId ,
                                        short AV11cCategoryId ,
                                        short AV14cProductCountryId )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF1A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cProductId } ,
                                                 new int[]{
                                                 TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.DECIMAL, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT,
                                                 TypeConstants.SHORT
                                                 }
            });
            lV7cProductName = StringUtil.Concat( StringUtil.RTrim( AV7cProductName), "%", "");
            /* Using cursor H001A2 */
            pr_default.execute(0, new Object[] {AV6cProductId, lV7cProductName, AV8cProductPrice, AV9cSellerId, AV10cSupplierId, AV11cCategoryId, AV14cProductCountryId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A41ProductCountryId = H001A2_A41ProductCountryId[0];
               A4CategoryId = H001A2_A4CategoryId[0];
               A24SupplierId = H001A2_A24SupplierId[0];
               A6SellerId = H001A2_A6SellerId[0];
               A40000ProductImage_GXI = H001A2_A40000ProductImage_GXI[0];
               AssignProp("", false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_84_Refreshing);
               AssignProp("", false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A13ProductPrice = H001A2_A13ProductPrice[0];
               A11ProductName = H001A2_A11ProductName[0];
               A10ProductId = H001A2_A10ProductId[0];
               A14ProductImage = H001A2_A14ProductImage[0];
               AssignProp("", false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_84_Refreshing);
               AssignProp("", false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               /* Execute user event: Load */
               E201A2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTID"+"_"+sGXsfl_84_idx, GetSecureSignedToken( sGXsfl_84_idx, context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cProductName = StringUtil.Concat( StringUtil.RTrim( AV7cProductName), "%", "");
         /* Using cursor H001A3 */
         pr_default.execute(1, new Object[] {AV6cProductId, lV7cProductName, AV8cProductPrice, AV9cSellerId, AV10cSupplierId, AV11cCategoryId, AV14cProductCountryId});
      ...
      protected void STRUP1A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCproductprice_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCproductprice_Internalname), ",", ".") > 999999999999999.99m ) ) )
            {
               ...
               wbErr = true;
               AV8cProductPrice = 0;
               AssignAttri("", false, "AV8cProductPrice", StringUtil.LTrimStr( AV8cProductPrice, 18, 2));
            }
            else
            {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCsellerid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCsellerid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV9cSellerId = 0;
               AssignAttri("", false, "AV9cSellerId", StringUtil.LTrimStr( (decimal)(AV9cSellerId), 4, 0));
            }
            else
            {
               AV9cSellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCsellerid_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV9cSellerId", StringUtil.LTrimStr( (decimal)(AV9cSellerId), 4, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV10cSupplierId = 0;
               AssignAttri("", false, "AV10cSupplierId", StringUtil.LTrimStr( (decimal)(AV10cSupplierId), 4, 0));
            }
            else
            {
               AV10cSupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10cSupplierId", StringUtil.LTrimStr( (decimal)(AV10cSupplierId), 4, 0));
            }
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCproductcountryid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCproductcountryid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV14cProductCountryId = 0;
               AssignAttri("", false, "AV14cProductCountryId", StringUtil.LTrimStr( (decimal)(AV14cProductCountryId), 4, 0));
            }
            else
            {
               AV14cProductCountryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCproductcountryid_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV14cProductCountryId", StringUtil.LTrimStr( (decimal)(AV14cProductCountryId), 4, 0));
            }
      ...
      protected void E191A2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Product", "", "", "", "", "", "", "", "");
      ...
      protected void E211A2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV12pProductId = A10ProductId;
         AssignAttri("", false, "AV12pProductId", StringUtil.LTrimStr( (decimal)(AV12pProductId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV12pProductId});
         context.setWebReturnParmsMetadata(new Object[] {"AV12pProductId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12pProductId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12pProductId", StringUtil.LTrimStr( (decimal)(AV12pProductId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411816283176", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0040.js", "?202411816283176", false, true);
      ...
      protected void SubsflControlProps_842( )
      {
         ...
         edtProductImage_Internalname = "PRODUCTIMAGE_"+sGXsfl_84_idx;
      ...
      protected void SubsflControlProps_fel_842( )
      {
         ...
         edtProductImage_Internalname = "PRODUCTIMAGE_"+sGXsfl_84_fel_idx;
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtProductImage_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A14ProductImage_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A24SupplierId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A24SupplierId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSupplierId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)84,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl84( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( A11ProductName));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtProductName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A13ProductPrice, 18, 2, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A14ProductImage));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A6SellerId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A24SupplierId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CategoryId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void initialize_properties( )
      {
         ...
         divProductcountryidfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         ...
         divSelleridfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductId","fld":"vCPRODUCTID","pic":"ZZZ9"},{"av":"AV7cProductName","fld":"vCPRODUCTNAME"},{"av":"AV8cProductPrice","fld":"vCPRODUCTPRICE","pic":"ZZZZZZZZZZZZZZ9.99"},{"av":"AV9cSellerId","fld":"vCSELLERID","pic":"ZZZ9"},{"av":"AV10cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV11cCategoryId","fld":"vCCATEGORYID","pic":"ZZZ9"},{"av":"AV14cProductCountryId","fld":"vCPRODUCTCOUNTRYID","pic":"ZZZ9"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E181A1","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLPRODUCTIDFILTER.CLICK","""{"handler":"E111A1","iparms":[{"av":"divProductidfiltercontainer_Class","ctrl":"PRODUCTIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPRODUCTNAMEFILTER.CLICK","""{"handler":"E121A1","iparms":[{"av":"divProductnamefiltercontainer_Class","ctrl":"PRODUCTNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPRODUCTPRICEFILTER.CLICK","""{"handler":"E131A1","iparms":[{"av":"divProductpricefiltercontainer_Class","ctrl":"PRODUCTPRICEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLSELLERIDFILTER.CLICK","""{"handler":"E141A1","iparms":[{"av":"divSelleridfiltercontainer_Class","ctrl":"SELLERIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLSUPPLIERIDFILTER.CLICK","""{"handler":"E151A1","iparms":[{"av":"divSupplieridfiltercontainer_Class","ctrl":"SUPPLIERIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCATEGORYIDFILTER.CLICK","""{"handler":"E161A1","iparms":[{"av":"divCategoryidfiltercontainer_Class","ctrl":"CATEGORYIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPRODUCTCOUNTRYIDFILTER.CLICK","""{"handler":"E171A1","iparms":[{"av":"divProductcountryidfiltercontainer_Class","ctrl":"PRODUCTCOUNTRYIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E211A2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV12pProductId","fld":"vPPRODUCTID","pic":"ZZZ9"}]}""");
         ...
         setEventMetadata("NULL","""{"handler":"Valid_Categoryid","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lV7cProductName = "";
         H001A2_A41ProductCountryId = new short[1] ;
         H001A2_A4CategoryId = new short[1] ;
         H001A2_A24SupplierId = new short[1] ;
         H001A2_A6SellerId = new short[1] ;
         H001A2_A40000ProductImage_GXI = new string[] {""} ;
         H001A2_A13ProductPrice = new decimal[1] ;
         H001A2_A11ProductName = new string[] {""} ;
         H001A2_A10ProductId = new short[1] ;
         H001A2_A14ProductImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0040__default(),
            new Object[][] {
                new Object[] {
               H001A2_A41ProductCountryId, H001A2_A4CategoryId, H001A2_A24SupplierId, H001A2_A6SellerId, H001A2_A40000ProductImage_GXI, H001A2_A13ProductPrice, H001A2_A11ProductName, H001A2_A10ProductId, H001A2_A14ProductImage
               }
               , new Object[] {
      ...
      private short AV12pProductId ;
      private short GRID1_nEOF ;
      private short nGotPars ;
      private short GxWebError ;
      private short AV6cProductId ;
      private short AV9cSellerId ;
      private short AV10cSupplierId ;
      private short AV11cCategoryId ;
      private short AV14cProductCountryId ;
      ...
      private short[] H001A2_A41ProductCountryId ;
      private short[] H001A2_A4CategoryId ;
      private short[] H001A2_A24SupplierId ;
      private short[] H001A2_A6SellerId ;
      private string[] H001A2_A40000ProductImage_GXI ;
      private decimal[] H001A2_A13ProductPrice ;
      private string[] H001A2_A11ProductName ;
      private short[] H001A2_A10ProductId ;
      private string[] H001A2_A14ProductImage ;
   ...
   public class gx0040__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cProductId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ProductCountryId], [CategoryId], [SupplierId], [SellerId], [ProductImage_GXI], [ProductPrice], [ProductName], [ProductId], [ProductImage]";
         ...
         if ( ! (0==AV9cSellerId) )
         {
            AddWhere(sWhereString, "([SellerId] >= @AV9cSellerId)");
         }
         else
         {
            GXv_int1[3] = 1;
         }
         if ( ! (0==AV10cSupplierId) )
         {
            AddWhere(sWhereString, "([SupplierId] >= @AV10cSupplierId)");
         }
         else
         {
            GXv_int1[4] = 1;
         ...
         if ( ! (0==AV14cProductCountryId) )
         {
            AddWhere(sWhereString, "([ProductCountryId] >= @AV14cProductCountryId)");
         }
         else
         {
            GXv_int1[6] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001A2(context, (string)dynConstraints[0] , (decimal)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (decimal)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
               case 1 :
                     return conditional_H001A3(context, (string)dynConstraints[0] , (decimal)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (decimal)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cProductName",GXType.NVarChar,40,0) ,
          new ParDef("@AV8cProductPrice",GXType.Decimal,18,2) ,
          new ParDef("@AV9cSellerId",GXType.Int16,4,0) ,
          new ParDef("@AV10cSupplierId",GXType.Int16,4,0) ,
          new ParDef("@AV11cCategoryId",GXType.Int16,4,0) ,
          new ParDef("@AV14cProductCountryId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001A2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001A2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001A3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001A3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
