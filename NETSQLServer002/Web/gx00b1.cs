   ...
   public class gx00b1 : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV7pPromotionId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV7pPromotionId", StringUtil.LTrimStr( (decimal)(AV7pPromotionId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pProductId = (short)(Math.Round(NumberUtil.Val( GetPar( "pProductId"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7pPromotionId = (short)(Math.Round(NumberUtil.Val( GetPar( "pPromotionId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromotionId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductId,4,0))}, new string[] {"pPromotionId","pProductId"}) +"\">") ;
      ...
      {
         return formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pPromotionId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductId,4,0))}, new string[] {"pPromotionId","pProductId"})  ;
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductidfilter_Internalname, "Product Id", "", "", lblLblproductidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111e1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121e1_client"+"'", TempTags, "", 2, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF1E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A26PromotionId = H001E2_A26PromotionId[0];
               A10ProductId = H001E2_A10ProductId[0];
               /* Execute user event: Load */
               E141E2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102516585620", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00b1.js", "?2024102516585621", false, true);
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtProductId_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ProductId), 4, 0, ",", "")))+"'"+"]);";
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPromotionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A26PromotionId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A26PromotionId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPromotionId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)24,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A26PromotionId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","""{"handler":"E121E1","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLPRODUCTIDFILTER.CLICK","""{"handler":"E111E1","iparms":[{"av":"divProductidfiltercontainer_Class","ctrl":"PRODUCTIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E151E2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         H001E2_A26PromotionId = new short[1] ;
         H001E2_A10ProductId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00b1__default(),
            new Object[][] {
                new Object[] {
               H001E2_A26PromotionId, H001E2_A10ProductId
               }
               , new Object[] {
      ...
      private short[] H001E2_A26PromotionId ;
      private short[] H001E2_A10ProductId ;
   ...
   public class gx00b1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001E2", "SELECT [PromotionId], [ProductId] FROM [PromotionProduct] WHERE [PromotionId] = @AV7pPromotionId and [ProductId] >= @AV6cProductId ORDER BY [PromotionId], [ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001E3", "SELECT COUNT(*) FROM [PromotionProduct] WHERE [PromotionId] = @AV7pPromotionId and [ProductId] >= @AV6cProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
