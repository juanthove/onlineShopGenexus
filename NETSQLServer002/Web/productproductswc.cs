...
namespace GeneXus.Programs {
   public class productproductswc : GXWebComponent
   {
      public productproductswc( )
      {
      ...
      public productproductswc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Product Products WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("productproductswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ProductId,4,0))}, new string[] {"ProductId"}) +"\">") ;
      ...
      {
         return "ProductProductsWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Product Products WC" ;
      }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productproductswc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductProductsWC.htm");
      ...
      protected void START1I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Product Products WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A10ProductId = H001I9_A10ProductId[0];
               AssignAttri(sPrefix, false, "A10ProductId", StringUtil.LTrimStr( (decimal)(A10ProductId), 4, 0));
               A2CountryName = H001I9_A2CountryName[0];
               A1CountryId = H001I9_A1CountryId[0];
               A17CustomerDirectionDestination = H001I9_A17CustomerDirectionDestination[0];
               A16CustomerName = H001I9_A16CustomerName[0];
               A15CustomerId = H001I9_A15CustomerId[0];
               A31ShoppingCartId = H001I9_A31ShoppingCartId[0];
               A33ShoppingCartTotalCost = H001I9_A33ShoppingCartTotalCost[0];
               n33ShoppingCartTotalCost = H001I9_n33ShoppingCartTotalCost[0];
               A34ShoppingCartDate = H001I9_A34ShoppingCartDate[0];
               A15CustomerId = H001I9_A15CustomerId[0];
               A34ShoppingCartDate = H001I9_A34ShoppingCartDate[0];
               A1CountryId = H001I9_A1CountryId[0];
               A17CustomerDirectionDestination = H001I9_A17CustomerDirectionDestination[0];
      ...
      {
         /* Using cursor H001I17 */
         pr_default.execute(1, new Object[] {AV6ProductId});
         GRID_nRecordCount = H001I17_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productproductswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410261640307", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productproductswc.js", "?202410261640307", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E131I2","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true},{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9"},{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E111I2","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         H001I9_A10ProductId = new short[1] ;
         H001I9_A2CountryName = new string[] {""} ;
         H001I9_A1CountryId = new short[1] ;
         H001I9_A17CustomerDirectionDestination = new string[] {""} ;
         H001I9_A16CustomerName = new string[] {""} ;
         H001I9_A15CustomerId = new short[1] ;
         H001I9_A31ShoppingCartId = new short[1] ;
         H001I9_A33ShoppingCartTotalCost = new decimal[1] ;
         H001I9_n33ShoppingCartTotalCost = new bool[] {false} ;
         H001I9_A34ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         H001I17_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productproductswc__default(),
            new Object[][] {
                new Object[] {
               H001I9_A10ProductId, H001I9_A2CountryName, H001I9_A1CountryId, H001I9_A17CustomerDirectionDestination, H001I9_A16CustomerName, H001I9_A15CustomerId, H001I9_A31ShoppingCartId, H001I9_A33ShoppingCartTotalCost, H001I9_n33ShoppingCartTotalCost, H001I9_A34ShoppingCartDate
               }
               , new Object[] {
               H001I17_AGRID_nRecordCount
               }
            }
         );
         AV15Pgmname = "ProductProductsWC";
      ...
      private short[] H001I9_A10ProductId ;
      private string[] H001I9_A2CountryName ;
      private short[] H001I9_A1CountryId ;
      private string[] H001I9_A17CustomerDirectionDestination ;
      private string[] H001I9_A16CustomerName ;
      private short[] H001I9_A15CustomerId ;
      private short[] H001I9_A31ShoppingCartId ;
      private decimal[] H001I9_A33ShoppingCartTotalCost ;
      private bool[] H001I9_n33ShoppingCartTotalCost ;
      private DateTime[] H001I9_A34ShoppingCartDate ;
      private long[] H001I17_AGRID_nRecordCount ;
   ...
   public class productproductswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH001I17;
          prmH001I17 = new Object[] {
          new ParDef("@AV6ProductId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001I9", cmdBufferH001I9,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I9,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001I17", "SELECT COUNT(*) FROM (((([ShoppingCartProducts] T1 INNER JOIN [ShoppingCart] T2 ON T2.[ShoppingCartId] = T1.[ShoppingCartId]) INNER JOIN [Customer] T3 ON T3.[CustomerId] = T2.[CustomerId]) INNER JOIN [Country] T4 ON T4.[CountryId] = T3.[CountryId]) LEFT JOIN (SELECT SUM(COALESCE( T7.[ProductTotalCost], 0)) AS ShoppingCartTotalCost, T6.[ShoppingCartId] FROM ([ShoppingCartProducts] T6 INNER JOIN (SELECT ( COALESCE( T9.[ProductFinalPrice], 0)) * CAST(T8.[ProductQuantity] AS decimal( 28, 10)) AS ProductTotalCost, T8.[ShoppingCartId], T8.[ProductId] FROM ([ShoppingCartProducts] T8 INNER JOIN (SELECT CASE  WHEN T13.[CategoryId] = COALESCE( T12.[CategoryId], 0) THEN T13.[ProductPrice] + ( T13.[ProductPrice] * CAST(0.05 AS decimal( 28, 10))) WHEN T13.[CategoryId] = COALESCE( T11.[CategoryId], 0) THEN T13.[ProductPrice] - ( T13.[ProductPrice] * CAST(0.1 AS decimal( 28, 10))) ELSE T13.[ProductPrice] END AS ProductFinalPrice, T10.[ShoppingCartId], T10.[ProductId] FROM ((([ShoppingCartProducts] T10 INNER JOIN [Product] T13 ON T13.[ProductId] = T10.[ProductId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Entretenimiento' ) T11 ON T11.[CategoryId] = T13.[CategoryId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Joyeria' ) T12 ON T12.[CategoryId] = T13.[CategoryId]) ) T9 ON T9.[ShoppingCartId] = T8.[ShoppingCartId] AND T9.[ProductId] = T8.[ProductId]) ) T7 ON T7.[ShoppingCartId] = T6.[ShoppingCartId] AND T7.[ProductId] = T6.[ProductId]) GROUP BY T6.[ShoppingCartId] ) T5 ON T5.[ShoppingCartId] = T1.[ShoppingCartId]) WHERE T1.[ProductId] = @AV6ProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I17,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
