...
namespace GeneXus.Programs {
   public class productproductwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ProductId = (short)(Math.Round(NumberUtil.Val( GetPar( "ProductId"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductProductWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtProductId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ProductId), 4, 0, ",", "")), StringUtil.LTrim( ((edtProductId_Enabled!=0) ? context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9") : context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,37);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductId_Jsonclick, 0, "Attribute", "", "", "", "", edtProductId_Visible, edtProductId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_ProductProductWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SHOPPINGCARTID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A31ShoppingCartId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"SHOPPINGCARTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31ShoppingCartId), 4, 0, ".", "")));
      }
      ...
      protected void RF192( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A10ProductId = H00199_A10ProductId[0];
               AssignAttri(sPrefix, false, "A10ProductId", StringUtil.LTrimStr( (decimal)(A10ProductId), 4, 0));
               A2CountryName = H00199_A2CountryName[0];
               A1CountryId = H00199_A1CountryId[0];
               A17CustomerDirectionDestination = H00199_A17CustomerDirectionDestination[0];
               A16CustomerName = H00199_A16CustomerName[0];
               A15CustomerId = H00199_A15CustomerId[0];
               A31ShoppingCartId = H00199_A31ShoppingCartId[0];
               A33ShoppingCartTotalCost = H00199_A33ShoppingCartTotalCost[0];
               n33ShoppingCartTotalCost = H00199_n33ShoppingCartTotalCost[0];
               A34ShoppingCartDate = H00199_A34ShoppingCartDate[0];
               A15CustomerId = H00199_A15CustomerId[0];
               A34ShoppingCartDate = H00199_A34ShoppingCartDate[0];
               A1CountryId = H00199_A1CountryId[0];
               A17CustomerDirectionDestination = H00199_A17CustomerDirectionDestination[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SHOPPINGCARTID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A31ShoppingCartId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H001917 */
         pr_default.execute(1, new Object[] {AV6ProductId});
         GRID_nRecordCount = H001917_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP190( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ProductId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ProductId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      private void E13192( )
      {
         ...
         edtavDelete_Link = formatLink("shoppingcart.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A31ShoppingCartId,4,0))}, new string[] {"Mode","ShoppingCartId"}) ;
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ProductId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6ProductId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6ProductId", StringUtil.LTrimStr( (decimal)(AV6ProductId), 4, 0));
         }
         else
         {
            AV6ProductId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6ProductId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241125021258", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productproductwc.js", "?20241125021258", false, true);
         }
      ...
      {
         edtShoppingCartId_Internalname = sPrefix+"SHOPPINGCARTID_"+sGXsfl_22_idx;
         edtShoppingCartDate_Internalname = sPrefix+"SHOPPINGCARTDATE_"+sGXsfl_22_idx;
         edtCustomerId_Internalname = sPrefix+"CUSTOMERID_"+sGXsfl_22_idx;
         edtCustomerName_Internalname = sPrefix+"CUSTOMERNAME_"+sGXsfl_22_idx;
         edtCustomerDirectionDestination_Internalname = sPrefix+"CUSTOMERDIRECTIONDESTINATION_"+sGXsfl_22_idx;
         edtCountryId_Internalname = sPrefix+"COUNTRYID_"+sGXsfl_22_idx;
         edtCountryName_Internalname = sPrefix+"COUNTRYNAME_"+sGXsfl_22_idx;
         edtShoppingCartTotalCost_Internalname = sPrefix+"SHOPPINGCARTTOTALCOST_"+sGXsfl_22_idx;
         edtShoppingCartDeliveryDate_Internalname = sPrefix+"SHOPPINGCARTDELIVERYDATE_"+sGXsfl_22_idx;
      ...
      {
         edtShoppingCartId_Internalname = sPrefix+"SHOPPINGCARTID_"+sGXsfl_22_fel_idx;
         edtShoppingCartDate_Internalname = sPrefix+"SHOPPINGCARTDATE_"+sGXsfl_22_fel_idx;
         edtCustomerId_Internalname = sPrefix+"CUSTOMERID_"+sGXsfl_22_fel_idx;
         edtCustomerName_Internalname = sPrefix+"CUSTOMERNAME_"+sGXsfl_22_fel_idx;
         edtCustomerDirectionDestination_Internalname = sPrefix+"CUSTOMERDIRECTIONDESTINATION_"+sGXsfl_22_fel_idx;
         ...
         edtShoppingCartTotalCost_Internalname = sPrefix+"SHOPPINGCARTTOTALCOST_"+sGXsfl_22_fel_idx;
         edtShoppingCartDeliveryDate_Internalname = sPrefix+"SHOPPINGCARTDELIVERYDATE_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CustomerId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCountryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CountryId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCountryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCountryName_Internalname,(string)A2CountryName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtCountryName_Link,(string)"",(string)"",(string)"",(string)edtCountryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtShoppingCartDeliveryDate_Internalname,context.localUtil.Format(A35ShoppingCartDeliveryDate, "99/99/99"),context.localUtil.Format( A35ShoppingCartDeliveryDate, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtShoppingCartDeliveryDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductId","fld":"vPRODUCTID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E13192","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true},{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9"},{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E11192","iparms":[{"av":"A31ShoppingCartId","fld":"SHOPPINGCARTID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductId","fld":"vPRODUCTID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductId","fld":"vPRODUCTID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductId","fld":"vPRODUCTID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ProductId","fld":"vPRODUCTID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H00199_A10ProductId = new short[1] ;
         H00199_A2CountryName = new string[] {""} ;
         H00199_A1CountryId = new short[1] ;
         H00199_A17CustomerDirectionDestination = new string[] {""} ;
         H00199_A16CustomerName = new string[] {""} ;
         H00199_A15CustomerId = new short[1] ;
         H00199_A31ShoppingCartId = new short[1] ;
         H00199_A33ShoppingCartTotalCost = new decimal[1] ;
         H00199_n33ShoppingCartTotalCost = new bool[] {false} ;
         H00199_A34ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         H001917_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productproductwc__default(),
            new Object[][] {
                new Object[] {
               H00199_A10ProductId, H00199_A2CountryName, H00199_A1CountryId, H00199_A17CustomerDirectionDestination, H00199_A16CustomerName, H00199_A15CustomerId, H00199_A31ShoppingCartId, H00199_A33ShoppingCartTotalCost, H00199_n33ShoppingCartTotalCost, H00199_A34ShoppingCartDate
               }
               , new Object[] {
               H001917_AGRID_nRecordCount
               }
            }
         );
         AV15Pgmname = "ProductProductWC";
      ...
      private short[] H00199_A10ProductId ;
      private string[] H00199_A2CountryName ;
      private short[] H00199_A1CountryId ;
      private string[] H00199_A17CustomerDirectionDestination ;
      private string[] H00199_A16CustomerName ;
      private short[] H00199_A15CustomerId ;
      private short[] H00199_A31ShoppingCartId ;
      private decimal[] H00199_A33ShoppingCartTotalCost ;
      private bool[] H00199_n33ShoppingCartTotalCost ;
      private DateTime[] H00199_A34ShoppingCartDate ;
      private long[] H001917_AGRID_nRecordCount ;
   ...
   public class productproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00199;
          prmH00199 = new Object[] {
          new ParDef("@AV6ProductId",GXType.Int16,4,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          string cmdBufferH00199;
          cmdBufferH00199=" SELECT T1.[ProductId], T4.[CountryName], T3.[CountryId], T3.[CustomerDirectionDestination], T3.[CustomerName], T2.[CustomerId], T1.[ShoppingCartId], COALESCE( T5.[ShoppingCartTotalCost], 0) AS ShoppingCartTotalCost, T2.[ShoppingCartDate] FROM (((([ShoppingCartProducts] T1 INNER JOIN [ShoppingCart] T2 ON T2.[ShoppingCartId] = T1.[ShoppingCartId]) INNER JOIN [Customer] T3 ON T3.[CustomerId] = T2.[CustomerId]) INNER JOIN [Country] T4 ON T4.[CountryId] = T3.[CountryId]) LEFT JOIN (SELECT SUM(COALESCE( T7.[ProductTotalCost], 0)) AS ShoppingCartTotalCost, T6.[ShoppingCartId] FROM ([ShoppingCartProducts] T6 INNER JOIN (SELECT ( COALESCE( T9.[ProductFinalPrice], 0)) * CAST(T8.[ProductQuantity] AS decimal( 28, 10)) AS ProductTotalCost, T8.[ShoppingCartId], T8.[ProductId] FROM ([ShoppingCartProducts] T8 INNER JOIN (SELECT CASE  WHEN T13.[CategoryId] = COALESCE( T12.[CategoryId], 0) THEN T13.[ProductPrice] + ( T13.[ProductPrice] * CAST(0.05 AS decimal( 28, 10))) WHEN T13.[CategoryId] = COALESCE( T11.[CategoryId], 0) THEN T13.[ProductPrice] - ( T13.[ProductPrice] * CAST(0.1 AS decimal( 28, 10))) ELSE T13.[ProductPrice] END AS ProductFinalPrice, T10.[ShoppingCartId], T10.[ProductId] FROM ((([ShoppingCartProducts] T10 INNER JOIN [Product] T13 ON T13.[ProductId] = T10.[ProductId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Entretenimiento' ) T11 ON T11.[CategoryId] = T13.[CategoryId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Joyeria' ) T12 ON T12.[CategoryId] = T13.[CategoryId]) ) T9 ON T9.[ShoppingCartId] = T8.[ShoppingCartId] AND T9.[ProductId] = T8.[ProductId]) ) T7 ON T7.[ShoppingCartId] = T6.[ShoppingCartId] AND T7.[ProductId] = T6.[ProductId]) GROUP BY T6.[ShoppingCartId] "
          + " ) T5 ON T5.[ShoppingCartId] = T1.[ShoppingCartId]) WHERE T1.[ProductId] = @AV6ProductId ORDER BY T1.[ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY" ;
          Object[] prmH001917;
          prmH001917 = new Object[] {
          new ParDef("@AV6ProductId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00199", cmdBufferH00199,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00199,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001917", "SELECT COUNT(*) FROM (((([ShoppingCartProducts] T1 INNER JOIN [ShoppingCart] T2 ON T2.[ShoppingCartId] = T1.[ShoppingCartId]) INNER JOIN [Customer] T3 ON T3.[CustomerId] = T2.[CustomerId]) INNER JOIN [Country] T4 ON T4.[CountryId] = T3.[CountryId]) LEFT JOIN (SELECT SUM(COALESCE( T7.[ProductTotalCost], 0)) AS ShoppingCartTotalCost, T6.[ShoppingCartId] FROM ([ShoppingCartProducts] T6 INNER JOIN (SELECT ( COALESCE( T9.[ProductFinalPrice], 0)) * CAST(T8.[ProductQuantity] AS decimal( 28, 10)) AS ProductTotalCost, T8.[ShoppingCartId], T8.[ProductId] FROM ([ShoppingCartProducts] T8 INNER JOIN (SELECT CASE  WHEN T13.[CategoryId] = COALESCE( T12.[CategoryId], 0) THEN T13.[ProductPrice] + ( T13.[ProductPrice] * CAST(0.05 AS decimal( 28, 10))) WHEN T13.[CategoryId] = COALESCE( T11.[CategoryId], 0) THEN T13.[ProductPrice] - ( T13.[ProductPrice] * CAST(0.1 AS decimal( 28, 10))) ELSE T13.[ProductPrice] END AS ProductFinalPrice, T10.[ShoppingCartId], T10.[ProductId] FROM ((([ShoppingCartProducts] T10 INNER JOIN [Product] T13 ON T13.[ProductId] = T10.[ProductId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Entretenimiento' ) T11 ON T11.[CategoryId] = T13.[CategoryId]) LEFT JOIN (SELECT [CategoryId] AS CategoryId, [CategoryName] FROM [Category] WHERE [CategoryName] = 'Joyeria' ) T12 ON T12.[CategoryId] = T13.[CategoryId]) ) T9 ON T9.[ShoppingCartId] = T8.[ShoppingCartId] AND T9.[ProductId] = T8.[ProductId]) ) T7 ON T7.[ShoppingCartId] = T6.[ShoppingCartId] AND T7.[ProductId] = T6.[ProductId]) GROUP BY T6.[ShoppingCartId] ) T5 ON T5.[ShoppingCartId] = T1.[ShoppingCartId]) WHERE T1.[ProductId] = @AV6ProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001917,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
