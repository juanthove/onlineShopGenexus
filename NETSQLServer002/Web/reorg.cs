...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreatePromotionProduct" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "RIPromotionProductPromotion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "RIPromotionProductProduct" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"PromotionProduct", ""}) );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[IPROMOTIONPRODUCT2]"}) );
         ReorgExecute.RegisterPrecedence( "RIPromotionProductPromotion" ,  "CreatePromotionProduct" );
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[IPROMOTIONPRODUCT1]"}) );
