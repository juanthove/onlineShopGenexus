   ...
   public class sellergeneral : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A6SellerId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sellergeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A6SellerId,4,0))}, new string[] {"SellerId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA6SellerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA6SellerId), 4, 0, ",", "")));
      }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110c1_client"+"'", TempTags, "", 2, "HLP_SellerGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120c1_client"+"'", TempTags, "", 2, "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtSellerName_Internalname, A7SellerName, StringUtil.RTrim( context.localUtil.Format( A7SellerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,23);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtSellerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgSellerPhoto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A8SellerPhoto_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000SellerPhoto_GXI = H000C2_A40000SellerPhoto_GXI[0];
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), true);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               A2CountryName = H000C2_A2CountryName[0];
               AssignAttri(sPrefix, false, "A2CountryName", A2CountryName);
               A1CountryId = H000C2_A1CountryId[0];
               AssignAttri(sPrefix, false, "A1CountryId", StringUtil.LTrimStr( (decimal)(A1CountryId), 4, 0));
               A7SellerName = H000C2_A7SellerName[0];
               AssignAttri(sPrefix, false, "A7SellerName", A7SellerName);
               A8SellerPhoto = H000C2_A8SellerPhoto[0];
               AssignAttri(sPrefix, false, "A8SellerPhoto", A8SellerPhoto);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), true);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               A2CountryName = H000C2_A2CountryName[0];
               AssignAttri(sPrefix, false, "A2CountryName", A2CountryName);
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(imgSellerPhoto_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA6SellerId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A6SellerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A6SellerId", StringUtil.LTrimStr( (decimal)(A6SellerId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA6SellerId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A6SellerId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A6SellerId", StringUtil.LTrimStr( (decimal)(A6SellerId), 4, 0));
         }
         wcpOA6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA6SellerId"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A6SellerId != wcpOA6SellerId ) ) )
         {
            setjustcreated();
         }
         wcpOA6SellerId = A6SellerId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA6SellerId = cgiGet( sPrefix+"A6SellerId_CTRL");
         if ( StringUtil.Len( sCtrlA6SellerId) > 0 )
         {
            A6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA6SellerId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A6SellerId", StringUtil.LTrimStr( (decimal)(A6SellerId), 4, 0));
         }
         else
         {
            A6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A6SellerId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A6SellerId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A6SellerId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA6SellerId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A6SellerId_CTRL", StringUtil.RTrim( sCtrlA6SellerId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101923454057", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("sellergeneral.js", "?2024101923454057", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9"},{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E110C1","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E120C1","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H000C2_A6SellerId = new short[1] ;
         H000C2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000C2_A2CountryName = new string[] {""} ;
         H000C2_A1CountryId = new short[1] ;
         H000C2_A7SellerName = new string[] {""} ;
         H000C2_A8SellerPhoto = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sellergeneral__default(),
            new Object[][] {
                new Object[] {
               H000C2_A6SellerId, H000C2_A40000SellerPhoto_GXI, H000C2_A2CountryName, H000C2_A1CountryId, H000C2_A7SellerName, H000C2_A8SellerPhoto
               }
            }
         );
         AV11Pgmname = "SellerGeneral";
      ...
      private string hsh ;
      private string sCtrlA6SellerId ;
      ...
      private short[] H000C2_A6SellerId ;
      private string[] H000C2_A40000SellerPhoto_GXI ;
      private string[] H000C2_A2CountryName ;
      private short[] H000C2_A1CountryId ;
      private string[] H000C2_A7SellerName ;
      private string[] H000C2_A8SellerPhoto ;
   ...
   public class sellergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT T1.[SellerId], T1.[SellerPhoto_GXI], T2.[CountryName], T1.[CountryId], T1.[SellerName], T1.[SellerPhoto] FROM ([Seller] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[SellerId] = @SellerId ORDER BY T1.[SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
