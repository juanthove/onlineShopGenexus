...
namespace GeneXus.Programs {
   public class sellerproductwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SellerId = (short)(Math.Round(NumberUtil.Val( GetPar( "SellerId"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6SellerId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void WB0V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SellerProductWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtSellerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A6SellerId), 4, 0, ",", "")), StringUtil.LTrim( ((edtSellerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A6SellerId), "ZZZ9") : context.localUtil.Format( (decimal)(A6SellerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,40);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerId_Jsonclick, 0, "Attribute", "", "", "", "", edtSellerId_Visible, edtSellerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_SellerProductWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6SellerId = H000V2_A6SellerId[0];
               AssignAttri(sPrefix, false, "A6SellerId", StringUtil.LTrimStr( (decimal)(A6SellerId), 4, 0));
               A40001ProductCountryFlag_GXI = H000V2_A40001ProductCountryFlag_GXI[0];
               n40001ProductCountryFlag_GXI = H000V2_n40001ProductCountryFlag_GXI[0];
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43ProductCountryFlag)) ? A40001ProductCountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A43ProductCountryFlag))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A43ProductCountryFlag), true);
               A42ProductCountryName = H000V2_A42ProductCountryName[0];
               A41ProductCountryId = H000V2_A41ProductCountryId[0];
               A5CategoryName = H000V2_A5CategoryName[0];
               A4CategoryId = H000V2_A4CategoryId[0];
               A25SupplierName = H000V2_A25SupplierName[0];
               A24SupplierId = H000V2_A24SupplierId[0];
               A40000ProductImage_GXI = H000V2_A40000ProductImage_GXI[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A13ProductPrice = H000V2_A13ProductPrice[0];
               A12ProductDescription = H000V2_A12ProductDescription[0];
               A11ProductName = H000V2_A11ProductName[0];
               A10ProductId = H000V2_A10ProductId[0];
               A43ProductCountryFlag = H000V2_A43ProductCountryFlag[0];
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43ProductCountryFlag)) ? A40001ProductCountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A43ProductCountryFlag))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A43ProductCountryFlag), true);
               A14ProductImage = H000V2_A14ProductImage[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A40001ProductCountryFlag_GXI = H000V2_A40001ProductCountryFlag_GXI[0];
               n40001ProductCountryFlag_GXI = H000V2_n40001ProductCountryFlag_GXI[0];
      ...
      protected void STRUP0V0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SellerId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6SellerId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6SellerId", StringUtil.LTrimStr( (decimal)(AV6SellerId), 4, 0));
         }
         else
         {
            AV6SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6SellerId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411250211884", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sellerproductwc.js", "?202411250211884", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SellerId","fld":"vSELLERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130V2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true},{"av":"A24SupplierId","fld":"SUPPLIERID","pic":"ZZZ9"},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtProductName_Link","ctrl":"PRODUCTNAME","prop":"Link"},{"av":"edtSupplierName_Link","ctrl":"SUPPLIERNAME","prop":"Link"},{"av":"edtCategoryName_Link","ctrl":"CATEGORYNAME","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110V2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SellerId","fld":"vSELLERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SellerId","fld":"vSELLERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SellerId","fld":"vSELLERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SellerId","fld":"vSELLERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000V2_A6SellerId = new short[1] ;
         H000V2_A40001ProductCountryFlag_GXI = new string[] {""} ;
         H000V2_n40001ProductCountryFlag_GXI = new bool[] {false} ;
         H000V2_A42ProductCountryName = new string[] {""} ;
         H000V2_A41ProductCountryId = new short[1] ;
         H000V2_A5CategoryName = new string[] {""} ;
         H000V2_A4CategoryId = new short[1] ;
         H000V2_A25SupplierName = new string[] {""} ;
         H000V2_A24SupplierId = new short[1] ;
         H000V2_A40000ProductImage_GXI = new string[] {""} ;
         H000V2_A13ProductPrice = new decimal[1] ;
         H000V2_A12ProductDescription = new string[] {""} ;
         H000V2_A11ProductName = new string[] {""} ;
         H000V2_A10ProductId = new short[1] ;
         H000V2_A43ProductCountryFlag = new string[] {""} ;
         H000V2_A14ProductImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sellerproductwc__default(),
            new Object[][] {
                new Object[] {
               H000V2_A6SellerId, H000V2_A40001ProductCountryFlag_GXI, H000V2_n40001ProductCountryFlag_GXI, H000V2_A42ProductCountryName, H000V2_A41ProductCountryId, H000V2_A5CategoryName, H000V2_A4CategoryId, H000V2_A25SupplierName, H000V2_A24SupplierId, H000V2_A40000ProductImage_GXI,
               H000V2_A13ProductPrice, H000V2_A12ProductDescription, H000V2_A11ProductName, H000V2_A10ProductId, H000V2_A43ProductCountryFlag, H000V2_A14ProductImage
               }
               , new Object[] {
      ...
      private short[] H000V2_A6SellerId ;
      private string[] H000V2_A40001ProductCountryFlag_GXI ;
      private bool[] H000V2_n40001ProductCountryFlag_GXI ;
      private string[] H000V2_A42ProductCountryName ;
      private short[] H000V2_A41ProductCountryId ;
      private string[] H000V2_A5CategoryName ;
      private short[] H000V2_A4CategoryId ;
      private string[] H000V2_A25SupplierName ;
      private short[] H000V2_A24SupplierId ;
      private string[] H000V2_A40000ProductImage_GXI ;
      private decimal[] H000V2_A13ProductPrice ;
      private string[] H000V2_A12ProductDescription ;
      private string[] H000V2_A11ProductName ;
      private short[] H000V2_A10ProductId ;
      private string[] H000V2_A43ProductCountryFlag ;
      private string[] H000V2_A14ProductImage ;
   ...
   public class sellerproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000V2", "SELECT T1.[SellerId], T2.[CountryFlag_GXI] AS ProductCountryFlag_GXI, T2.[CountryName] AS ProductCountryName, T1.[ProductCountryId] AS ProductCountryId, T3.[CategoryName], T1.[CategoryId], T4.[SupplierName], T1.[SupplierId], T1.[ProductImage_GXI], T1.[ProductPrice], T1.[ProductDescription], T1.[ProductName], T1.[ProductId], T2.[CountryFlag] AS ProductCountryFlag, T1.[ProductImage] FROM ((([Product] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[ProductCountryId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T1.[CategoryId]) INNER JOIN [Supplier] T4 ON T4.[SupplierId] = T1.[SupplierId]) WHERE T1.[SellerId] = @AV6SellerId ORDER BY T1.[SellerId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000V2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000V3", "SELECT COUNT(*) FROM ((([Product] T1 INNER JOIN [Country] T4 ON T4.[CountryId] = T1.[ProductCountryId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T1.[CategoryId]) INNER JOIN [Supplier] T2 ON T2.[SupplierId] = T1.[SupplierId]) WHERE T1.[SellerId] = @AV6SellerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000V3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
