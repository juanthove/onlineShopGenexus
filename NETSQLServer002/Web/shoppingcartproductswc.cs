...
namespace GeneXus.Programs {
   public class shoppingcartproductswc : GXWebComponent
   {
      public shoppingcartproductswc( )
      {
      ...
      public shoppingcartproductswc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV13Pgmname = "ShoppingCartProductsWC";
               WS1K2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Shopping Cart Products WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("shoppingcartproductswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ShoppingCartId,4,0))}, new string[] {"ShoppingCartId"}) +"\">") ;
      ...
      {
         return "ShoppingCartProductsWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Shopping Cart Products WC" ;
      }
      ...
      protected void WB1K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "shoppingcartproductswc.aspx");
            }
            /* Div Control */
      ...
      protected void START1K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Shopping Cart Products WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF1K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A31ShoppingCartId = H001K7_A31ShoppingCartId[0];
               AssignAttri(sPrefix, false, "A31ShoppingCartId", StringUtil.LTrimStr( (decimal)(A31ShoppingCartId), 4, 0));
               A5CategoryName = H001K7_A5CategoryName[0];
               A4CategoryId = H001K7_A4CategoryId[0];
               A13ProductPrice = H001K7_A13ProductPrice[0];
               A12ProductDescription = H001K7_A12ProductDescription[0];
               A11ProductName = H001K7_A11ProductName[0];
               A10ProductId = H001K7_A10ProductId[0];
               A37ProductQuantity = H001K7_A37ProductQuantity[0];
               A39ProductFinalPrice = H001K7_A39ProductFinalPrice[0];
               n39ProductFinalPrice = H001K7_n39ProductFinalPrice[0];
               A4CategoryId = H001K7_A4CategoryId[0];
               A13ProductPrice = H001K7_A13ProductPrice[0];
               A12ProductDescription = H001K7_A12ProductDescription[0];
               A11ProductName = H001K7_A11ProductName[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001K13_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "shoppingcartproductswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410261643598", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("shoppingcartproductswc.js", "?202410261643598", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E121K2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9"},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         A5CategoryName = "";
         H001K7_A31ShoppingCartId = new short[1] ;
         H001K7_A5CategoryName = new string[] {""} ;
         H001K7_A4CategoryId = new short[1] ;
         H001K7_A13ProductPrice = new decimal[1] ;
         H001K7_A12ProductDescription = new string[] {""} ;
         H001K7_A11ProductName = new string[] {""} ;
         H001K7_A10ProductId = new short[1] ;
         H001K7_A37ProductQuantity = new long[1] ;
         H001K7_A39ProductFinalPrice = new decimal[1] ;
         H001K7_n39ProductFinalPrice = new bool[] {false} ;
         H001K13_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.shoppingcartproductswc__default(),
            new Object[][] {
                new Object[] {
               H001K7_A31ShoppingCartId, H001K7_A5CategoryName, H001K7_A4CategoryId, H001K7_A13ProductPrice, H001K7_A12ProductDescription, H001K7_A11ProductName, H001K7_A10ProductId, H001K7_A37ProductQuantity, H001K7_A39ProductFinalPrice, H001K7_n39ProductFinalPrice
               }
               , new Object[] {
               H001K13_AGRID_nRecordCount
               }
            }
         );
         AV13Pgmname = "ShoppingCartProductsWC";
      ...
      private short[] H001K7_A31ShoppingCartId ;
      private string[] H001K7_A5CategoryName ;
      private short[] H001K7_A4CategoryId ;
      private decimal[] H001K7_A13ProductPrice ;
      private string[] H001K7_A12ProductDescription ;
      private string[] H001K7_A11ProductName ;
      private short[] H001K7_A10ProductId ;
      private long[] H001K7_A37ProductQuantity ;
      private decimal[] H001K7_A39ProductFinalPrice ;
      private bool[] H001K7_n39ProductFinalPrice ;
      private long[] H001K13_AGRID_nRecordCount ;
   ...
   public class shoppingcartproductswc__default : DataStoreHelperBase, IDataStoreHelper
   {
