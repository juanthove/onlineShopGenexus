...
namespace GeneXus.Programs {
   public class supplierproductwc : GXWebComponent
   {
      public supplierproductwc( )
      {
      ...
      public supplierproductwc( IGxContext context )
      {
      ...
      public void execute( short aP0_SupplierId )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SupplierId = (short)(Math.Round(NumberUtil.Val( GetPar( "SupplierId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6SupplierId", StringUtil.LTrimStr( (decimal)(AV6SupplierId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SupplierId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6SupplierId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Supplier Product WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplierproductwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SupplierId,4,0))}, new string[] {"SupplierId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SupplierId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SupplierId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SupplierId), 4, 0, ",", "")));
      ...
      {
         return "SupplierProductWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Supplier Product WC" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "supplierproductwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierProductWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtSupplierId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A24SupplierId), 4, 0, ",", "")), StringUtil.LTrim( ((edtSupplierId_Enabled!=0) ? context.localUtil.Format( (decimal)(A24SupplierId), "ZZZ9") : context.localUtil.Format( (decimal)(A24SupplierId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,40);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierId_Visible, edtSupplierId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_SupplierProductWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Supplier Product WC", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
                              ...
                              AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43ProductCountryFlag)) ? A40001ProductCountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A43ProductCountryFlag))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A43ProductCountryFlag), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUCTID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PRODUCTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ProductId), 4, 0, ".", "")));
      }
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV6SupplierId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A24SupplierId = H000X2_A24SupplierId[0];
               AssignAttri(sPrefix, false, "A24SupplierId", StringUtil.LTrimStr( (decimal)(A24SupplierId), 4, 0));
               A40001ProductCountryFlag_GXI = H000X2_A40001ProductCountryFlag_GXI[0];
               n40001ProductCountryFlag_GXI = H000X2_n40001ProductCountryFlag_GXI[0];
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43ProductCountryFlag)) ? A40001ProductCountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A43ProductCountryFlag))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A43ProductCountryFlag), true);
               A42ProductCountryName = H000X2_A42ProductCountryName[0];
               A41ProductCountryId = H000X2_A41ProductCountryId[0];
               A5CategoryName = H000X2_A5CategoryName[0];
               A4CategoryId = H000X2_A4CategoryId[0];
               A7SellerName = H000X2_A7SellerName[0];
               A6SellerId = H000X2_A6SellerId[0];
               A40000ProductImage_GXI = H000X2_A40000ProductImage_GXI[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A13ProductPrice = H000X2_A13ProductPrice[0];
               A12ProductDescription = H000X2_A12ProductDescription[0];
               A11ProductName = H000X2_A11ProductName[0];
               A10ProductId = H000X2_A10ProductId[0];
               A43ProductCountryFlag = H000X2_A43ProductCountryFlag[0];
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43ProductCountryFlag)) ? A40001ProductCountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A43ProductCountryFlag))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A43ProductCountryFlag), true);
               A14ProductImage = H000X2_A14ProductImage[0];
               AssignProp(sPrefix, false, edtProductImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14ProductImage)) ? A40000ProductImage_GXI : context.convertURL( context.PathToRelativeUrl( A14ProductImage))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtProductImage_Internalname, "SrcSet", context.GetImageSrcSet( A14ProductImage), true);
               A40001ProductCountryFlag_GXI = H000X2_A40001ProductCountryFlag_GXI[0];
               n40001ProductCountryFlag_GXI = H000X2_n40001ProductCountryFlag_GXI[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUCTID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A10ProductId), "ZZZ9"), context));
      }
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SupplierId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SupplierId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SupplierId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SupplierId", StringUtil.LTrimStr( (decimal)(AV6SupplierId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "supplierproductwc", GetJustCreated( ));
         ...
         {
            AV6SupplierId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SupplierId", StringUtil.LTrimStr( (decimal)(AV6SupplierId), 4, 0));
         }
         wcpOAV6SupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SupplierId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6SupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6SupplierId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6SupplierId", StringUtil.LTrimStr( (decimal)(AV6SupplierId), 4, 0));
         }
         else
         {
            AV6SupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6SupplierId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SupplierId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SupplierId), 4, 0, ",", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411250211759", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("supplierproductwc.js", "?202411250211759", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtProductImage_Internalname = sPrefix+"PRODUCTIMAGE_"+sGXsfl_22_idx;
         edtSellerId_Internalname = sPrefix+"SELLERID_"+sGXsfl_22_idx;
         edtSellerName_Internalname = sPrefix+"SELLERNAME_"+sGXsfl_22_idx;
         edtCategoryId_Internalname = sPrefix+"CATEGORYID_"+sGXsfl_22_idx;
         edtCategoryName_Internalname = sPrefix+"CATEGORYNAME_"+sGXsfl_22_idx;
         edtProductCountryId_Internalname = sPrefix+"PRODUCTCOUNTRYID_"+sGXsfl_22_idx;
         edtProductCountryName_Internalname = sPrefix+"PRODUCTCOUNTRYNAME_"+sGXsfl_22_idx;
         edtProductCountryFlag_Internalname = sPrefix+"PRODUCTCOUNTRYFLAG_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtProductImage_Internalname = sPrefix+"PRODUCTIMAGE_"+sGXsfl_22_fel_idx;
         edtSellerId_Internalname = sPrefix+"SELLERID_"+sGXsfl_22_fel_idx;
         edtSellerName_Internalname = sPrefix+"SELLERNAME_"+sGXsfl_22_fel_idx;
         edtCategoryId_Internalname = sPrefix+"CATEGORYID_"+sGXsfl_22_fel_idx;
         edtCategoryName_Internalname = sPrefix+"CATEGORYNAME_"+sGXsfl_22_fel_idx;
         edtProductCountryId_Internalname = sPrefix+"PRODUCTCOUNTRYID_"+sGXsfl_22_fel_idx;
         edtProductCountryName_Internalname = sPrefix+"PRODUCTCOUNTRYNAME_"+sGXsfl_22_fel_idx;
         edtProductCountryFlag_Internalname = sPrefix+"PRODUCTCOUNTRYFLAG_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSellerName_Internalname,(string)A7SellerName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtSellerName_Link,(string)"",(string)"",(string)"",(string)edtSellerName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductCountryName_Internalname,(string)A42ProductCountryName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductCountryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtProductImage_Internalname = sPrefix+"PRODUCTIMAGE";
         ...
         edtProductCountryFlag_Internalname = sPrefix+"PRODUCTCOUNTRYFLAG";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130X2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true},{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9"},{"av":"A4CategoryId","fld":"CATEGORYID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtProductName_Link","ctrl":"PRODUCTNAME","prop":"Link"},{"av":"edtSellerName_Link","ctrl":"SELLERNAME","prop":"Link"},{"av":"edtCategoryName_Link","ctrl":"CATEGORYNAME","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110X2","iparms":[{"av":"A10ProductId","fld":"PRODUCTID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000X2_A24SupplierId = new short[1] ;
         H000X2_A40001ProductCountryFlag_GXI = new string[] {""} ;
         H000X2_n40001ProductCountryFlag_GXI = new bool[] {false} ;
         H000X2_A42ProductCountryName = new string[] {""} ;
         H000X2_A41ProductCountryId = new short[1] ;
         H000X2_A5CategoryName = new string[] {""} ;
         H000X2_A4CategoryId = new short[1] ;
         H000X2_A7SellerName = new string[] {""} ;
         H000X2_A6SellerId = new short[1] ;
         H000X2_A40000ProductImage_GXI = new string[] {""} ;
         H000X2_A13ProductPrice = new decimal[1] ;
         H000X2_A12ProductDescription = new string[] {""} ;
         H000X2_A11ProductName = new string[] {""} ;
         H000X2_A10ProductId = new short[1] ;
         H000X2_A43ProductCountryFlag = new string[] {""} ;
         H000X2_A14ProductImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplierproductwc__default(),
            new Object[][] {
                new Object[] {
               H000X2_A24SupplierId, H000X2_A40001ProductCountryFlag_GXI, H000X2_n40001ProductCountryFlag_GXI, H000X2_A42ProductCountryName, H000X2_A41ProductCountryId, H000X2_A5CategoryName, H000X2_A4CategoryId, H000X2_A7SellerName, H000X2_A6SellerId, H000X2_A40000ProductImage_GXI,
               H000X2_A13ProductPrice, H000X2_A12ProductDescription, H000X2_A11ProductName, H000X2_A10ProductId, H000X2_A43ProductCountryFlag, H000X2_A14ProductImage
               }
               , new Object[] {
      ...
      private short AV6SupplierId ;
      private short wcpOAV6SupplierId ;
      ...
      private short[] H000X2_A24SupplierId ;
      private string[] H000X2_A40001ProductCountryFlag_GXI ;
      private bool[] H000X2_n40001ProductCountryFlag_GXI ;
      private string[] H000X2_A42ProductCountryName ;
      private short[] H000X2_A41ProductCountryId ;
      private string[] H000X2_A5CategoryName ;
      private short[] H000X2_A4CategoryId ;
      private string[] H000X2_A7SellerName ;
      private short[] H000X2_A6SellerId ;
      private string[] H000X2_A40000ProductImage_GXI ;
      private decimal[] H000X2_A13ProductPrice ;
      private string[] H000X2_A12ProductDescription ;
      private string[] H000X2_A11ProductName ;
      private short[] H000X2_A10ProductId ;
      private string[] H000X2_A43ProductCountryFlag ;
      private string[] H000X2_A14ProductImage ;
   ...
   public class supplierproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6SupplierId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT T1.[SupplierId], T2.[CountryFlag_GXI] AS ProductCountryFlag_GXI, T2.[CountryName] AS ProductCountryName, T1.[ProductCountryId] AS ProductCountryId, T3.[CategoryName], T1.[CategoryId], T4.[SellerName], T1.[SellerId], T1.[ProductImage_GXI], T1.[ProductPrice], T1.[ProductDescription], T1.[ProductName], T1.[ProductId], T2.[CountryFlag] AS ProductCountryFlag, T1.[ProductImage] FROM ((([Product] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[ProductCountryId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T1.[CategoryId]) INNER JOIN [Seller] T4 ON T4.[SellerId] = T1.[SellerId]) WHERE T1.[SupplierId] = @AV6SupplierId ORDER BY T1.[SupplierId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000X3", "SELECT COUNT(*) FROM ((([Product] T1 INNER JOIN [Country] T4 ON T4.[CountryId] = T1.[ProductCountryId]) INNER JOIN [Category] T3 ON T3.[CategoryId] = T1.[CategoryId]) INNER JOIN [Seller] T2 ON T2.[SellerId] = T1.[SellerId]) WHERE T1.[SupplierId] = @AV6SupplierId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[14])[0] = rslt.getMultimediaFile(14, rslt.getVarchar(2));
                ((string[]) buf[15])[0] = rslt.getMultimediaFile(15, rslt.getVarchar(9));
                return;
             case 1 :
