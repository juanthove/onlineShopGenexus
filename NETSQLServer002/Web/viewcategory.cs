   ...
   public class viewcategory : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CategoryId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("CategoryName", StringUtil.RTrim( context.localUtil.Format( A5CategoryName, "")));
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Categories", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCategory.htm");
            ...
            GxWebStd.gx_label_element( context, edtCategoryName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, A5CategoryName, StringUtil.RTrim( context.localUtil.Format( A5CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewCategory.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4CategoryId = H00072_A4CategoryId[0];
               A5CategoryName = H00072_A5CategoryName[0];
      ...
      protected void STRUP070( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12CategoryId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCATEGORYID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E11072( )
      {
         ...
         {
            A4CategoryId = H00073_A4CategoryId[0];
            A5CategoryName = H00073_A5CategoryName[0];
            AssignAttri("", false, "A5CategoryName", A5CategoryName);
            AV14GXLvl7 = 1;
            Form.Caption = A5CategoryName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12CategoryId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12CategoryId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241092002052", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcategory.js", "?20241092002052", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12CategoryId","fld":"vCATEGORYID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A5CategoryName","fld":"CATEGORYNAME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00072_A4CategoryId = new short[1] ;
         H00072_A5CategoryName = new string[] {""} ;
         hsh = "";
         H00073_A4CategoryId = new short[1] ;
         H00073_A5CategoryName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcategory__default(),
            new Object[][] {
                new Object[] {
               H00072_A4CategoryId, H00072_A5CategoryName
               }
               , new Object[] {
               H00073_A4CategoryId, H00073_A5CategoryName
               }
            }
         );
      ...
      private short[] H00072_A4CategoryId ;
      private string[] H00072_A5CategoryName ;
      private short[] H00073_A4CategoryId ;
      private string[] H00073_A5CategoryName ;
   ...
   public class viewcategory__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00072", "SELECT [CategoryId], [CategoryName] FROM [Category] WHERE [CategoryId] = @AV12CategoryId ORDER BY [CategoryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00072,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00073", "SELECT [CategoryId], [CategoryName] FROM [Category] WHERE [CategoryId] = @AV12CategoryId ORDER BY [CategoryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00073,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
