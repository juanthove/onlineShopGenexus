   ...
   public class viewproduct : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProductId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ProductName", StringUtil.RTrim( context.localUtil.Format( A11ProductName, "")));
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Products", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewProduct.htm");
            ...
            GxWebStd.gx_label_element( context, edtProductName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtProductName_Internalname, A11ProductName, StringUtil.RTrim( context.localUtil.Format( A11ProductName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtProductName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewProduct.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Shopping Cart", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct1_title_Internalname, "Promotion", "", "", lblProduct1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProduct.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableproduct1_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0042"+"", StringUtil.RTrim( WebComp_Product1wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 42 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
                           {
                              WebComp_Product1wc.componentprocess("W0042", "", sEvt);
                           }
                           WebComp_Product1wc_Component = OldProduct1wc;
                        }
                     }
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A10ProductId = H000D2_A10ProductId[0];
               A11ProductName = H000D2_A11ProductName[0];
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vPRODUCTID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E110D2( )
      {
         ...
         {
            A10ProductId = H000D3_A10ProductId[0];
            A11ProductName = H000D3_A11ProductName[0];
            AssignAttri("", false, "A11ProductName", A11ProductName);
            AV14GXLvl7 = 1;
            Form.Caption = A11ProductName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12ProductId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12ProductId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product1") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Product1wc_Component) != 0 )
            {
               ...
               WebComp_Product1wc.componentprepare(new Object[] {(string)"W0042",(string)"",(short)AV12ProductId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411816282855", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproduct.js", "?202411816282855", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12ProductId","fld":"vPRODUCTID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A11ProductName","fld":"PRODUCTNAME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000D2_A10ProductId = new short[1] ;
         H000D2_A11ProductName = new string[] {""} ;
         hsh = "";
         H000D3_A10ProductId = new short[1] ;
         H000D3_A11ProductName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproduct__default(),
            new Object[][] {
                new Object[] {
               H000D2_A10ProductId, H000D2_A11ProductName
               }
               , new Object[] {
               H000D3_A10ProductId, H000D3_A11ProductName
               }
            }
         );
      ...
      private short[] H000D2_A10ProductId ;
      private string[] H000D2_A11ProductName ;
      private short[] H000D3_A10ProductId ;
      private string[] H000D3_A11ProductName ;
   ...
   public class viewproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [ProductId], [ProductName] FROM [Product] WHERE [ProductId] = @AV12ProductId ORDER BY [ProductId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000D3", "SELECT [ProductId], [ProductName] FROM [Product] WHERE [ProductId] = @AV12ProductId ORDER BY [ProductId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
