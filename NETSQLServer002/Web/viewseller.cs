   ...
   public class viewseller : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12SellerId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("SellerName", StringUtil.RTrim( context.localUtil.Format( A7SellerName, "")));
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Sellers", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewSeller.htm");
            ...
            GxWebStd.gx_label_element( context, edtSellerName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtSellerName_Internalname, A7SellerName, StringUtil.RTrim( context.localUtil.Format( A7SellerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtSellerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewSeller.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6SellerId = H000A2_A6SellerId[0];
               A7SellerName = H000A2_A7SellerName[0];
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12SellerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSELLERID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E110A2( )
      {
         ...
         {
            A6SellerId = H000A3_A6SellerId[0];
            A7SellerName = H000A3_A7SellerName[0];
            AssignAttri("", false, "A7SellerName", A7SellerName);
            AV14GXLvl7 = 1;
            Form.Caption = A7SellerName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12SellerId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12SellerId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101923454123", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewseller.js", "?2024101923454123", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12SellerId","fld":"vSELLERID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A7SellerName","fld":"SELLERNAME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000A2_A6SellerId = new short[1] ;
         H000A2_A7SellerName = new string[] {""} ;
         hsh = "";
         H000A3_A6SellerId = new short[1] ;
         H000A3_A7SellerName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewseller__default(),
            new Object[][] {
                new Object[] {
               H000A2_A6SellerId, H000A2_A7SellerName
               }
               , new Object[] {
               H000A3_A6SellerId, H000A3_A7SellerName
               }
            }
         );
      ...
      private short[] H000A2_A6SellerId ;
      private string[] H000A2_A7SellerName ;
      private short[] H000A3_A6SellerId ;
      private string[] H000A3_A7SellerName ;
   ...
   public class viewseller__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "SELECT [SellerId], [SellerName] FROM [Seller] WHERE [SellerId] = @AV12SellerId ORDER BY [SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000A3", "SELECT [SellerId], [SellerName] FROM [Seller] WHERE [SellerId] = @AV12SellerId ORDER BY [SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
