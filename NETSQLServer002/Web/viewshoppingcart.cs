   ...
   public class viewshoppingcart : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ShoppingCartId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ShoppingCartDate", context.localUtil.Format(A34ShoppingCartDate, "99/99/99"));
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Shopping Carts", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewShoppingCart.htm");
            ...
            GxWebStd.gx_label_element( context, edtShoppingCartDate_Internalname, "Cart Date", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtShoppingCartDate_Internalname, context.localUtil.Format(A34ShoppingCartDate, "99/99/99"), context.localUtil.Format( A34ShoppingCartDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtShoppingCartDate_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtShoppingCartDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ViewShoppingCart.htm");
            GxWebStd.gx_bitmap( context, edtShoppingCartDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtShoppingCartDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewShoppingCart.htm");
      ...
      protected void RF132( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A31ShoppingCartId = H00132_A31ShoppingCartId[0];
               A34ShoppingCartDate = H00132_A34ShoppingCartDate[0];
      ...
      protected void STRUP130( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ShoppingCartId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSHOPPINGCARTID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E11132( )
      {
         ...
         {
            A31ShoppingCartId = H00133_A31ShoppingCartId[0];
            A34ShoppingCartDate = H00133_A34ShoppingCartDate[0];
            AssignAttri("", false, "A34ShoppingCartDate", context.localUtil.Format(A34ShoppingCartDate, "99/99/99"));
            AV14GXLvl7 = 1;
            Form.Caption = context.localUtil.DToC( A34ShoppingCartDate, 2, "/");
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12ShoppingCartId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12ShoppingCartId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102616564827", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewshoppingcart.js", "?2024102616564828", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12ShoppingCartId","fld":"vSHOPPINGCARTID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A34ShoppingCartDate","fld":"SHOPPINGCARTDATE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00132_A31ShoppingCartId = new short[1] ;
         H00132_A34ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H00133_A31ShoppingCartId = new short[1] ;
         H00133_A34ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewshoppingcart__default(),
            new Object[][] {
                new Object[] {
               H00132_A31ShoppingCartId, H00132_A34ShoppingCartDate
               }
               , new Object[] {
               H00133_A31ShoppingCartId, H00133_A34ShoppingCartDate
               }
            }
         );
      ...
      private short[] H00132_A31ShoppingCartId ;
      private DateTime[] H00132_A34ShoppingCartDate ;
      private short[] H00133_A31ShoppingCartId ;
      private DateTime[] H00133_A34ShoppingCartDate ;
   ...
   public class viewshoppingcart__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00132", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00132,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00133", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00133,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
