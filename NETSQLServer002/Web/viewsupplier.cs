...
namespace GeneXus.Programs {
   public class viewsupplier : GXDataArea
   {
      public viewsupplier( )
      {
      ...
      public viewsupplier( IGxContext context )
      {
      ...
      public void execute( short aP0_SupplierId ,
                           string aP1_TabCode )
      {
         this.AV12SupplierId = aP0_SupplierId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12SupplierId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12SupplierId", StringUtil.LTrimStr( (decimal)(AV12SupplierId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SupplierId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewsupplier.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SupplierId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SupplierId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12SupplierId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SupplierId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewSupplier");
         forbiddenHiddens.Add("SupplierName", StringUtil.RTrim( context.localUtil.Format( A25SupplierName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewsupplier:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewsupplier.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SupplierId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SupplierId","TabCode"})  ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Suppliers", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewSupplier.htm");
            ...
            GxWebStd.gx_label_element( context, edtSupplierName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtSupplierName_Internalname, A25SupplierName, StringUtil.RTrim( context.localUtil.Format( A25SupplierName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtSupplierName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewSupplier.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSupplier.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSupplier.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START0M2( )
      {
         ...
         Form.Meta.addItem("description", "View Supplier", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0M2( )
      {
         ...
         {
            /* Using cursor H000M2 */
            pr_default.execute(0, new Object[] {AV12SupplierId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A24SupplierId = H000M2_A24SupplierId[0];
               A25SupplierName = H000M2_A25SupplierName[0];
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12SupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSUPPLIERID"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewsupplier:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110M2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000M3 */
         pr_default.execute(1, new Object[] {AV12SupplierId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A24SupplierId = H000M3_A24SupplierId[0];
            A25SupplierName = H000M3_A25SupplierName[0];
            AssignAttri("", false, "A25SupplierName", A25SupplierName);
            AV14GXLvl7 = 1;
            Form.Caption = A25SupplierName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwsupplier.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "SupplierGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "suppliergeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "SupplierGeneral";
               WebComp_Generalwc_Component = "SupplierGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12SupplierId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "SupplierProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "supplierproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "SupplierProductWC";
               WebComp_Productwc_Component = "SupplierProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12SupplierId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12SupplierId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12SupplierId", StringUtil.LTrimStr( (decimal)(AV12SupplierId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SupplierId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241092002349", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewsupplier.js", "?20241092002349", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12SupplierId","fld":"vSUPPLIERID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A25SupplierName","fld":"SUPPLIERNAME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000M2_A24SupplierId = new short[1] ;
         H000M2_A25SupplierName = new string[] {""} ;
         hsh = "";
         H000M3_A24SupplierId = new short[1] ;
         H000M3_A25SupplierName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewsupplier__default(),
            new Object[][] {
                new Object[] {
               H000M2_A24SupplierId, H000M2_A25SupplierName
               }
               , new Object[] {
               H000M3_A24SupplierId, H000M3_A25SupplierName
               }
            }
         );
      ...
      private short AV12SupplierId ;
      private short wcpOAV12SupplierId ;
      ...
      private short[] H000M2_A24SupplierId ;
      private string[] H000M2_A25SupplierName ;
      private short[] H000M3_A24SupplierId ;
      private string[] H000M3_A25SupplierName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewsupplier__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12SupplierId",GXType.Int16,4,0)
          };
          Object[] prmH000M3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000M2", "SELECT [SupplierId], [SupplierName] FROM [Supplier] WHERE [SupplierId] = @AV12SupplierId ORDER BY [SupplierId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000M3", "SELECT [SupplierId], [SupplierName] FROM [Supplier] WHERE [SupplierId] = @AV12SupplierId ORDER BY [SupplierId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
