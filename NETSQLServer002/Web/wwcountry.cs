...
namespace GeneXus.Programs {
   public class wwcountry : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCOUNTRYNAME", AV11CountryName);
         /* Send saved values. */
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCountry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCountryname_Internalname, AV11CountryName, StringUtil.RTrim( context.localUtil.Format( AV11CountryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavCountryname_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCountryname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWCountry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3CountryFlag)) ? A40000CountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A3CountryFlag))), !bGXsfl_27_Refreshing);
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_COUNTRYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "COUNTRYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CountryId), 4, 0, ".", "")));
      }
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11CountryName = StringUtil.Concat( StringUtil.RTrim( AV11CountryName), "%", "");
            /* Using cursor H00052 */
            ...
            {
               A40000CountryFlag_GXI = H00052_A40000CountryFlag_GXI[0];
               AssignProp("", false, edtCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3CountryFlag)) ? A40000CountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A3CountryFlag))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A3CountryFlag), true);
               A2CountryName = H00052_A2CountryName[0];
               A1CountryId = H00052_A1CountryId[0];
               A3CountryFlag = H00052_A3CountryFlag[0];
               AssignProp("", false, edtCountryFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3CountryFlag)) ? A40000CountryFlag_GXI : context.convertURL( context.PathToRelativeUrl( A3CountryFlag))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtCountryFlag_Internalname, "SrcSet", context.GetImageSrcSet( A3CountryFlag), true);
               /* Execute user event: Grid.Load */
               E14052 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_COUNTRYID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A1CountryId), "ZZZ9"), context));
      }
      ...
      private void E14052( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("country.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A1CountryId,4,0))}, new string[] {"Mode","CountryId"}) ;
         edtavDelete_Link = formatLink("country.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A1CountryId,4,0))}, new string[] {"Mode","CountryId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411250211664", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcountry.js", "?202411250211664", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtCountryFlag_Internalname = "COUNTRYFLAG_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtCountryFlag_Internalname = "COUNTRYFLAG_"+sGXsfl_27_fel_idx;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A3CountryFlag));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E14052","iparms":[{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E11052","iparms":[{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11CountryName = "";
         H00052_A40000CountryFlag_GXI = new string[] {""} ;
         H00052_A2CountryName = new string[] {""} ;
         H00052_A1CountryId = new short[1] ;
         H00052_A3CountryFlag = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcountry__default(),
            new Object[][] {
                new Object[] {
               H00052_A40000CountryFlag_GXI, H00052_A2CountryName, H00052_A1CountryId, H00052_A3CountryFlag
               }
               , new Object[] {
      ...
      private string[] H00052_A40000CountryFlag_GXI ;
      private string[] H00052_A2CountryName ;
      private short[] H00052_A1CountryId ;
      private string[] H00052_A3CountryFlag ;
   ...
   public class wwcountry__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11CountryName",GXType.NVarChar,40,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00052", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00052,1, GxCacheFrequency.OFF ,true,false )
