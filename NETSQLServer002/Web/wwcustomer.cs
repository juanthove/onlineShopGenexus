...
namespace GeneXus.Programs {
   public class wwcustomer : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCUSTOMERNAME", AV11CustomerName);
         /* Send saved values. */
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Customers", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWCustomer.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCustomer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavCustomername_Internalname, "Customer Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCustomername_Internalname, AV11CustomerName, StringUtil.RTrim( context.localUtil.Format( AV11CustomerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavCustomername_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCustomername_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWCustomer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11CustomerName = StringUtil.Concat( StringUtil.RTrim( AV11CustomerName), "%", "");
            /* Using cursor H000H2 */
            ...
            {
               A19CustomerPhone = H000H2_A19CustomerPhone[0];
               A18CustomerEmail = H000H2_A18CustomerEmail[0];
               A17CustomerDirectionDestination = H000H2_A17CustomerDirectionDestination[0];
               A2CountryName = H000H2_A2CountryName[0];
               A1CountryId = H000H2_A1CountryId[0];
               A16CustomerName = H000H2_A16CustomerName[0];
               A15CustomerId = H000H2_A15CustomerId[0];
               A2CountryName = H000H2_A2CountryName[0];
               /* Execute user event: Grid.Load */
               E140H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CUSTOMERID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A15CustomerId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101923263845", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcustomer.js", "?2024101923263846", false, true);
         }
      ...
      {
         edtCustomerId_Internalname = "CUSTOMERID_"+sGXsfl_27_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_27_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_27_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_27_idx;
         edtCustomerDirectionDestination_Internalname = "CUSTOMERDIRECTIONDESTINATION_"+sGXsfl_27_idx;
         edtCustomerEmail_Internalname = "CUSTOMEREMAIL_"+sGXsfl_27_idx;
         edtCustomerPhone_Internalname = "CUSTOMERPHONE_"+sGXsfl_27_idx;
      ...
      {
         edtCustomerId_Internalname = "CUSTOMERID_"+sGXsfl_27_fel_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_27_fel_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_27_fel_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_27_fel_idx;
         edtCustomerDirectionDestination_Internalname = "CUSTOMERDIRECTIONDESTINATION_"+sGXsfl_27_fel_idx;
         edtCustomerEmail_Internalname = "CUSTOMEREMAIL_"+sGXsfl_27_fel_idx;
         edtCustomerPhone_Internalname = "CUSTOMERPHONE_"+sGXsfl_27_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CustomerName","fld":"vCUSTOMERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140H2","iparms":[{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true},{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110H2","iparms":[{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CustomerName","fld":"vCUSTOMERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CustomerName","fld":"vCUSTOMERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CustomerName","fld":"vCUSTOMERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CustomerName","fld":"vCUSTOMERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11CustomerName = "";
         H000H2_A19CustomerPhone = new string[] {""} ;
         H000H2_A18CustomerEmail = new string[] {""} ;
         H000H2_A17CustomerDirectionDestination = new string[] {""} ;
         H000H2_A2CountryName = new string[] {""} ;
         H000H2_A1CountryId = new short[1] ;
         H000H2_A16CustomerName = new string[] {""} ;
         H000H2_A15CustomerId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcustomer__default(),
            new Object[][] {
                new Object[] {
               H000H2_A19CustomerPhone, H000H2_A18CustomerEmail, H000H2_A17CustomerDirectionDestination, H000H2_A2CountryName, H000H2_A1CountryId, H000H2_A16CustomerName, H000H2_A15CustomerId
               }
               , new Object[] {
      ...
      private string[] H000H2_A19CustomerPhone ;
      private string[] H000H2_A18CustomerEmail ;
      private string[] H000H2_A17CustomerDirectionDestination ;
      private string[] H000H2_A2CountryName ;
      private short[] H000H2_A1CountryId ;
      private string[] H000H2_A16CustomerName ;
      private short[] H000H2_A15CustomerId ;
   ...
   public class wwcustomer__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A16CustomerName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[CustomerPhone], T1.[CustomerEmail], T1.[CustomerDirectionDestination], T2.[CountryName], T1.[CountryId], T1.[CustomerName], T1.[CustomerId]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11CustomerName",GXType.NVarChar,40,0) ,
