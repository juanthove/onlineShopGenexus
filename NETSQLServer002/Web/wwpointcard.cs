...
namespace GeneXus.Programs {
   public class wwpointcard : GXDataArea
   {
      public wwpointcard( )
      {
      ...
      public wwpointcard( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV15PointCardId = (short)(Math.Round(NumberUtil.Val( GetPar( "PointCardId"), "."), 18, MidpointRounding.ToEven));
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV15PointCardId, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpointcard.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPOINTCARDID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15PointCardId), 4, 0, ",", "")));
         /* Send saved values. */
      ...
      {
         return formatLink("wwpointcard.aspx")  ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Point Cards", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPointCard.htm");
            ...
            GxWebStd.gx_label_element( context, edtavPointcardid_Internalname, "Point Card Id", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'',false,'" + sGXsfl_23_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPointcardid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15PointCardId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavPointcardid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV15PointCardId), "ZZZ9") : context.localUtil.Format( (decimal)(AV15PointCardId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Card Id", edtavPointcardid_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPointcardid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WWPointCard.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0K2( )
      {
         ...
         Form.Meta.addItem("description", "Point Cards", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Pointcardid Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vPOINTCARDID"), ",", ".") != Convert.ToDecimal( AV15PointCardId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0K2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavPointcardid_Internalname;
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV15PointCardId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_23_idx = 1;
            sGXsfl_23_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_23_idx), 4, 0), 4, "0");
            SubsflControlProps_232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A23PointCardVIP = H000K2_A23PointCardVIP[0];
               A22PointCardPoints = H000K2_A22PointCardPoints[0];
               A16CustomerName = H000K2_A16CustomerName[0];
               A15CustomerId = H000K2_A15CustomerId[0];
               A20PointCardId = H000K2_A20PointCardId[0];
               A16CustomerName = H000K2_A16CustomerName[0];
               /* Execute user event: Grid.Load */
               E130K2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV15PointCardId});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV15PointCardId = (short)(Math.Round(NumberUtil.Val( GridState.FilterValues("Pointcardid"), "."), 18, MidpointRounding.ToEven));
            AssignAttri("", false, "AV15PointCardId", StringUtil.LTrimStr( (decimal)(AV15PointCardId), 4, 0));
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PointCardId", StringUtil.Str( (decimal)(AV15PointCardId), 4, 0));
      }
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavPointcardid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavPointcardid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vPOINTCARDID");
               GX_FocusControl = edtavPointcardid_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV15PointCardId = 0;
            ...
            {
               AV15PointCardId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavPointcardid_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV15PointCardId", StringUtil.LTrimStr( (decimal)(AV15PointCardId), 4, 0));
            }
      ...
      private void E130K2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("pointcard.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A20PointCardId,4,0))}, new string[] {"Mode","PointCardId"}) ;
         edtavDelete_Link = formatLink("pointcard.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A20PointCardId,4,0))}, new string[] {"Mode","PointCardId"}) ;
         edtPointCardId_Link = formatLink("viewpointcard.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A20PointCardId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"PointCardId","TabCode"}) ;
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "PointCard";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241161946262", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpointcard.js", "?20241161946262", false, true);
         }
      ...
      {
         edtPointCardId_Internalname = "POINTCARDID_"+sGXsfl_23_idx;
         edtCustomerId_Internalname = "CUSTOMERID_"+sGXsfl_23_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_23_idx;
         edtPointCardPoints_Internalname = "POINTCARDPOINTS_"+sGXsfl_23_idx;
         chkPointCardVIP_Internalname = "POINTCARDVIP_"+sGXsfl_23_idx;
      ...
      {
         edtPointCardId_Internalname = "POINTCARDID_"+sGXsfl_23_fel_idx;
         edtCustomerId_Internalname = "CUSTOMERID_"+sGXsfl_23_fel_idx;
         edtCustomerName_Internalname = "CUSTOMERNAME_"+sGXsfl_23_fel_idx;
         edtPointCardPoints_Internalname = "POINTCARDPOINTS_"+sGXsfl_23_fel_idx;
         chkPointCardVIP_Internalname = "POINTCARDVIP_"+sGXsfl_23_fel_idx;
      ...
      protected void sendrow_232( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_23_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPointCardId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A20PointCardId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A20PointCardId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtPointCardId_Link,(string)"",(string)"",(string)"",(string)edtPointCardId_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)23,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPointCardPoints_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A22PointCardPoints), 8, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A22PointCardPoints), "ZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPointCardPoints_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)23,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "POINTCARDVIP_" + sGXsfl_23_idx;
            chkPointCardVIP.Name = GXCCtl;
            chkPointCardVIP.WebTags = "";
            chkPointCardVIP.Caption = "";
            AssignProp("", false, chkPointCardVIP_Internalname, "TitleCaption", chkPointCardVIP.Caption, !bGXsfl_23_Refreshing);
            chkPointCardVIP.CheckedValue = "false";
            A23PointCardVIP = StringUtil.StrToBool( StringUtil.BoolToStr( A23PointCardVIP));
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkPointCardVIP_Internalname,StringUtil.BoolToStr( A23PointCardVIP),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"column column-optional",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 30,'',false,'" + sGXsfl_23_idx + "',23)\"";
            ROClassString = "TextActionAttribute TextLikeLink";
      ...
      protected void StartGridControl23( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Card Points") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Card VIP") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A20PointCardId), 4, 0, ".", ""))));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtPointCardId_Link));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A22PointCardPoints), 8, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A23PointCardVIP)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavPointcardid_Internalname = "vPOINTCARDID";
      ...
      public override void initialize_properties( )
      {
         ...
         edtCustomerId_Enabled = 0;
         edtPointCardId_Enabled = 0;
         edtavPointcardid_Jsonclick = "";
         edtavPointcardid_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15PointCardId","fld":"vPOINTCARDID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130K2","iparms":[{"av":"A20PointCardId","fld":"POINTCARDID","pic":"ZZZ9"},{"av":"A15CustomerId","fld":"CUSTOMERID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtPointCardId_Link","ctrl":"POINTCARDID","prop":"Link"},{"av":"edtCustomerName_Link","ctrl":"CUSTOMERNAME","prop":"Link"}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15PointCardId","fld":"vPOINTCARDID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15PointCardId","fld":"vPOINTCARDID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15PointCardId","fld":"vPOINTCARDID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV15PointCardId","fld":"vPOINTCARDID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000K2_A23PointCardVIP = new bool[] {false} ;
         H000K2_A22PointCardPoints = new int[1] ;
         H000K2_A16CustomerName = new string[] {""} ;
         H000K2_A15CustomerId = new short[1] ;
         H000K2_A20PointCardId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpointcard__default(),
            new Object[][] {
                new Object[] {
               H000K2_A23PointCardVIP, H000K2_A22PointCardPoints, H000K2_A16CustomerName, H000K2_A15CustomerId, H000K2_A20PointCardId
               }
               , new Object[] {
      ...
      private int edtavPointcardid_Enabled ;
      ...
      private string edtavPointcardid_Internalname ;
      private string TempTags ;
      private string edtavPointcardid_Jsonclick ;
      ...
      private string edtPointCardId_Link ;
      ...
      private bool[] H000K2_A23PointCardVIP ;
      private int[] H000K2_A22PointCardPoints ;
      private string[] H000K2_A16CustomerName ;
      private short[] H000K2_A15CustomerId ;
      private short[] H000K2_A20PointCardId ;
   ...
   public class wwpointcard__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000K2( IGxContext context ,
                                             short AV15PointCardId ,
                                             short A20PointCardId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[PointCardVIP], T1.[PointCardPoints], T2.[CustomerName], T1.[CustomerId], T1.[PointCardId]";
         sFromString = " FROM ([PointCard] T1 INNER JOIN [Customer] T2 ON T2.[CustomerId] = T1.[CustomerId])";
         sOrderString = "";
         if ( ! (0==AV15PointCardId) )
         {
            AddWhere(sWhereString, "(T1.[PointCardId] >= @AV15PointCardId)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[PointCardId]";
                                             ...
                                             short A20PointCardId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([PointCard] T1 INNER JOIN [Customer] T2 ON T2.[CustomerId] = T1.[CustomerId])";
         if ( ! (0==AV15PointCardId) )
         {
            AddWhere(sWhereString, "(T1.[PointCardId] >= @AV15PointCardId)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000K2(context, (short)dynConstraints[0] , (short)dynConstraints[1] );
               case 1 :
                     return conditional_H000K3(context, (short)dynConstraints[0] , (short)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV15PointCardId",GXType.Int16,4,0) ,
