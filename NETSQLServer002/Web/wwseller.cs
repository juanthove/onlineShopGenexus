...
namespace GeneXus.Programs {
   public class wwseller : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSELLERNAME", AV11SellerName);
         /* Send saved values. */
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Sellers", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWSeller.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSeller.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavSellername_Internalname, "Seller Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSellername_Internalname, AV11SellerName, StringUtil.RTrim( context.localUtil.Format( AV11SellerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavSellername_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavSellername_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWSeller.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_27_Refreshing);
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11SellerName = StringUtil.Concat( StringUtil.RTrim( AV11SellerName), "%", "");
            /* Using cursor H000B2 */
            ...
            {
               A2CountryName = H000B2_A2CountryName[0];
               A1CountryId = H000B2_A1CountryId[0];
               A40000SellerPhoto_GXI = H000B2_A40000SellerPhoto_GXI[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               A7SellerName = H000B2_A7SellerName[0];
               A6SellerId = H000B2_A6SellerId[0];
               A8SellerPhoto = H000B2_A8SellerPhoto[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A8SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A8SellerPhoto))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A8SellerPhoto), true);
               A2CountryName = H000B2_A2CountryName[0];
               /* Execute user event: Grid.Load */
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SELLERID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A6SellerId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102318395363", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwseller.js", "?2024102318395363", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtSellerPhoto_Internalname = "SELLERPHOTO_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtSellerPhoto_Internalname = "SELLERPHOTO_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtSellerPhoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"column column-optional",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A8SellerPhoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A8SellerPhoto));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SellerName","fld":"vSELLERNAME"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140B2","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9","hsh":true},{"av":"A1CountryId","fld":"COUNTRYID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110B2","iparms":[{"av":"A6SellerId","fld":"SELLERID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SellerName","fld":"vSELLERNAME"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SellerName","fld":"vSELLERNAME"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SellerName","fld":"vSELLERNAME"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SellerName","fld":"vSELLERNAME"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11SellerName = "";
         H000B2_A2CountryName = new string[] {""} ;
         H000B2_A1CountryId = new short[1] ;
         H000B2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000B2_A7SellerName = new string[] {""} ;
         H000B2_A6SellerId = new short[1] ;
         H000B2_A8SellerPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwseller__default(),
            new Object[][] {
                new Object[] {
               H000B2_A2CountryName, H000B2_A1CountryId, H000B2_A40000SellerPhoto_GXI, H000B2_A7SellerName, H000B2_A6SellerId, H000B2_A8SellerPhoto
               }
               , new Object[] {
      ...
      private string[] H000B2_A2CountryName ;
      private short[] H000B2_A1CountryId ;
      private string[] H000B2_A40000SellerPhoto_GXI ;
      private string[] H000B2_A7SellerName ;
      private short[] H000B2_A6SellerId ;
      private string[] H000B2_A8SellerPhoto ;
   ...
   public class wwseller__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11SellerName",GXType.NVarChar,40,0) ,
