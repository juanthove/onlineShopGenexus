...
namespace GeneXus.Programs {
   public class wwsupplier : GXDataArea
   {
      public wwsupplier( )
      {
      ...
      public wwsupplier( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11SupplierName = GetPar( "SupplierName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11SupplierName, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwsupplier.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSUPPLIERNAME", AV11SupplierName);
         /* Send saved values. */
      ...
      {
         return formatLink("wwsupplier.aspx")  ;
      }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Suppliers", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWSupplier.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSupplier.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavSuppliername_Internalname, AV11SupplierName, StringUtil.RTrim( context.localUtil.Format( AV11SupplierName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavSuppliername_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavSuppliername_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWSupplier.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0N2( )
      {
         ...
         Form.Meta.addItem("description", "Suppliers", 0) ;
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vSUPPLIERNAME"), AV11SupplierName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A24SupplierId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "SUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24SupplierId), 4, 0, ".", "")));
      }
      ...
      protected void RF0N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11SupplierName = StringUtil.Concat( StringUtil.RTrim( AV11SupplierName), "%", "");
            /* Using cursor H000N2 */
            pr_default.execute(0, new Object[] {lV11SupplierName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A25SupplierName = H000N2_A25SupplierName[0];
               A24SupplierId = H000N2_A24SupplierId[0];
               /* Execute user event: Grid.Load */
               E140N2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A24SupplierId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11SupplierName = StringUtil.Concat( StringUtil.RTrim( AV11SupplierName), "%", "");
         /* Using cursor H000N3 */
         pr_default.execute(1, new Object[] {lV11SupplierName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11SupplierName = GridState.FilterValues("Suppliername");
            AssignAttri("", false, "AV11SupplierName", AV11SupplierName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("SupplierName", AV11SupplierName);
      }
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11SupplierName = cgiGet( edtavSuppliername_Internalname);
            AssignAttri("", false, "AV11SupplierName", AV11SupplierName);
      ...
      private void E140N2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("supplier.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A24SupplierId,4,0))}, new string[] {"Mode","SupplierId"}) ;
         edtavDelete_Link = formatLink("supplier.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A24SupplierId,4,0))}, new string[] {"Mode","SupplierId"}) ;
      ...
      protected void E110N2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("supplier.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","SupplierId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Supplier";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024109200243", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwsupplier.js", "?2024109200243", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SupplierName","fld":"vSUPPLIERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140N2","iparms":[{"av":"A24SupplierId","fld":"SUPPLIERID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtSupplierName_Link","ctrl":"SUPPLIERNAME","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110N2","iparms":[{"av":"A24SupplierId","fld":"SUPPLIERID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SupplierName","fld":"vSUPPLIERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SupplierName","fld":"vSUPPLIERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SupplierName","fld":"vSUPPLIERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SupplierName","fld":"vSUPPLIERNAME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11SupplierName = "";
         H000N2_A25SupplierName = new string[] {""} ;
         H000N2_A24SupplierId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsupplier__default(),
            new Object[][] {
                new Object[] {
               H000N2_A25SupplierName, H000N2_A24SupplierId
               }
               , new Object[] {
      ...
      private string AV11SupplierName ;
      private string A25SupplierName ;
      private string lV11SupplierName ;
      ...
      private string[] H000N2_A25SupplierName ;
      private short[] H000N2_A24SupplierId ;
   ...
   public class wwsupplier__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000N2( IGxContext context ,
                                             string AV11SupplierName ,
                                             string A25SupplierName )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SupplierName)) )
         {
            AddWhere(sWhereString, "([SupplierName] like @lV11SupplierName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [SupplierName]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11SupplierName",GXType.NVarChar,40,0) ,
